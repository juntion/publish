...
class socialmedia_oauth_connect_abel
{
  	...
  	public function Initialize(){
  		...
  		switch($this->provider)
		{
			...
			case 'Facebook':
				...
				$this->responseType="code";
				$this->userProfileUrl = "https://graph.facebook.com/v2.8/me?fields=email,birthday,name&access_token=";
				$this->header="";
				break;
	...
	public function debugFacebookJson($data){
		...
		echo "<script type=\"text/javascript\">
		$.ajax({
			url: '../ajax_customers_social_media_login_A.php?ajax_request_action=facebook',
