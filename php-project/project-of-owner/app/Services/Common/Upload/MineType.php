...
use Upload\Validation\Mimetype as M;

class MineType extends M
{

    public function __construct($mimetypes)
    {
        parent::__construct($mimetypes);
        $this->message = defined("FS_UPLOAD_NEW_NOTICE_TWO") ?
            FS_UPLOAD_NEW_NOTICE_TWO :'Please use a  JPG, GIF, PNG, JPEG, or BMP file.';
    }
