 ...
 */
  ...
  //by tom add image_alt
    function zen_get_image_alt($product_id, $language_id) {
    global $db;
    $product = $db->Execute("select image_alt
                             from " . TABLE_META_TAGS_PRODUCTS_DESCRIPTION . "
                             where products_id = '" . (int)$product_id . "'
                             and language_id = '" . (int)$language_id . "'");

    return $product->fields['image_alt'];
  }
 ...
 */
  ...
  function zen_get_category_metatags_keywords($category_id, $language_id) {
    ...
    //by tom add image_alt
    function zen_get_category_image_alt($category_id, $language_id) {
    global $db;
    $category = $db->Execute("select image_alt
                              from " . TABLE_METATAGS_CATEGORIES_DESCRIPTION . "
                              where categories_id = '" . (int)$category_id . "'
                              and language_id = '" . (int)$language_id . "'");
    return $category->fields['image_alt'];
  }
