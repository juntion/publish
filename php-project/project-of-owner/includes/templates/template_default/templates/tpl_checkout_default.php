...
<div class="m_top">
  <span class="m_live"><a href="<?php echo reset_url('service/fs_support.html');?>" target="_blank" ><span class="icon iconfont">&#xf137;</span></a></span>
  <span class="m_logo">
        ...
        <div class="checkout_payment">
          <div class="Payment_select"> 
            <!-- <select class="login_country" name="payment_method" id="paymentMethod_select">
                      ...
                      <option value="hsbc" <?php echo ('hsbc' == $payment_method) ? ' selected="selected"' : '';?>>Bank Transfer</option>
                    </select> -->
            <?php
               $default_payment = zen_get_customer_default_set_payment_method($_SESSION['customer_id']);
			   $globalcollect_currency = array('AUD','CAD','EUR','GBP','HKD','JPY','RUB','SGD','USD','CHF');
          ...
          <div class="Payment_wen" style="display: <?php echo ('hsbc' == $payment_method) ? ' block"' : ' none';?>;" id="hsbc">
            <fieldset style="border:0px dotted gray">
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cartInfo">
                <tbody>
                  <!-- <tr>
							        <td colspan="2">Bank Transfer beneficiary details:</td>
							    </tr> -->
                  <tr>
  ...
  ?>
      ...
      <!-- <div class="check2_Payment_Total"  style="display:<?php echo $no_shipping ? 'none': 'block';?>;">
                <table class="shopping_cart shopping_cart_checkout" width="100%" cellspacing="0" cellpadding="10" border="0">
                  <tr>
                    ...
                    <td class="text_right checkout_05" width="80">&nbsp;<strong><?php echo $currency_symbol_left;?><?php echo $currencies->fs_format($order_total_lists[0]['value'], true, $order->info['currency'], $order->info['currency_value']);//number_format($order_total_lists[0]['value'],2,'.','');?></td>
                    </tr>
                  <tr>
                    <td class="text_right checkout_05 checkout_08"><?php echo $order_total_lists[1]['title'];?></td>
                    <td class="text_right checkout_05 checkout_08"><strong>&nbsp;<?php echo $currency_symbol_left;?></strong><span id="shipping_cost"><?php echo $currencies->fs_format($order_total_lists[1]['value'], true, $order->info['currency'], $order->info['currency_value']);//number_format($order_total_lists[1]['value'],2,'.','');?></td>
                    </tr>
                  <tr>
                    <td align="right" class="text_right checkout_05 checkout_06 checkout_06_size"><?php echo $order_total_lists[2]['title'];?></td>
                    <td class="text_right checkout_05 checkout_06"><strong>&nbsp;<?php echo $currency_symbol_left;?></strong><span id="total_fee"><?php echo $currencies->fs_format($order_total_lists[2]['value'], true, $order->info['currency'], $order->info['currency_value']);//number_format($order_total_lists[2]['value'],2,'.','');?></td>
                    </tr>
                </table>
              </div> -->
      <div class="aaa">
      ...
      <div class="checkout_offset">
        <div class="checkout_price">
          <ul>
            <li class="price_width"><span class="aaa"><?php echo FIBER_CHECK_SUB;?>:</span><?php echo $currency_symbol_left;?><?php echo $currencies->fs_format($order_total_lists[0]['value'], true, $order->info['currency'], $order->info['currency_value']);//number_format($order_total_lists[0]['value'],2,'.','');?></li>
          </ul>
        </div>
       <div class="checkout_send">
			...
			<span class="aaa">[+]<?php echo FIBER_CHECK_COST;?>:</span>
			 <?php 
...
<?php if($address['entry_state'] == 'Washington'){ ?>
	...
	<?php
        ...
        <div class="shopping_cart_04">
          <dl>
            <dd class="shopping_cart_04_03">&nbsp;<?php echo $currency_symbol_left;?><span id="total_fee"><?php echo $currencies->fs_format($order_total_lists[0]['value'], true, $order->info['currency'], $order->info['currency_value']);?></span></dd>
