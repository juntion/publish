...
; (function ($) {
    $.fn.extend({
        "nav": function (con) {
            var $this = $(this), $nav = $this.find('.switch-tab'), t = (con && con.t) || 4800, a = (con && con.a) || 1000, i = 0, autoChange = function () {
		...
		<div id="inner">
			<div class="hot-event">
				...
				<div class="event-item" <?php if($k==0){echo 'style="display:block"';}else{echo 'style="display:none"';}?> >
					<a href="<?php echo $v[3]?>" class=""  target="_blank">
						<!--pc-->
						<img src="<?php echo $v[0]?>" alt="<?php echo $v[2]?>"  class="m_none" />
						<!--mobile-->
						<img src="<?php echo $v[1]?>" alt="<?php echo $v[2]?>"  class="m_display"/>
					</a>
				</div>
				<?php }} ?>
