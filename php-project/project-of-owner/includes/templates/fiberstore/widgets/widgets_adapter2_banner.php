...
<div id="inner_2">
  <div class="hot-event adapter_banner">
    <div class="switch-nav"><a href="javascript:;" onclick="return false;" class="prev"><i class="ico i-prev"></i><span class="hide-clip">Pre</span></a><a href="<?php echo zen_href_link(FILENAME_FIBERSTORE_WITH_PARTNERS);?>" onclick="return false;" class="next"><i class="ico i-next"></i><span class="hide-clip">Next</span></a></div>
      ...
      <img src="<?php echo HTTPS_IMAGE_SERVER;?>/images/adapter_pic05.jpg" alt="Fiberstore adapter_pic05.jpg" width="240" height="466">
    </div>


     <div class="event-item"  style="display: none;">
	   <img src="<?php echo HTTPS_IMAGE_SERVER;?>/images/adapter_pic06.jpg" alt="Fiberstore adapter_pic06.jpg" width="240" height="466">
    </div>

     <div class="event-item" style="display: none;">
      <img src="<?php echo HTTPS_IMAGE_SERVER;?>/images/adapter_pic07.jpg" alt="Fiberstore adapter_pic07.jpg" width="240" height="466">
    </div>
    <div class="event-item" style="display: none;">
      <img src="<?php echo HTTPS_IMAGE_SERVER;?>/images/adapter_pic08.jpg" alt="Fiberstore adapter_pic08.jpg" width="240" height="466">
    </div>
...
<!--    <div class="switch-tab"> <a href="javascript:;" onclick="return false;" class="current">1</a> <a href="javascript:;" onclick="return false;">2</a> <a href="javascript:;" onclick="return false;">3</a>  <a href="javascript:;" onclick="return false;">4</a> </div>-->
  </div>
</div>
<script type="text/javascript">
        $('#inner_2').nav({ t: 4500, a: 1000 });
    </script>
