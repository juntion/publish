...
<div style="position: relative;padding: 80px;" class="proforma_invoice">
                    ...
                    <tr>
                        ...
                        <td style="font-family: Microsoft YaHei, 思源黑体 CN Light;">
                            ...
                            if($invocie_date && $invocie_date!='0000-00-00 00:00:00'){
                                echo date("m . d . Y",strtotime($invocie_date));
                            }else{
                                echo '--';
                            }
                            ?>
    ...
    <table width="100%" border="1" cellpadding="11" cellspacing="0" bordercolor="#6c6d70" style="font-size: 12px;line-height: 16px;color: #333;word-wrap: break-word;border-collapse: collapse;">
        ...
        <tr class="print_tr" align="center" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;background-color: #6c6d70;color: #fff;line-height: 13px;">
            <td width="32%" style="border: 0;border-right: 1px solid #fff;padding-left: 5px;padding-right: 5px;font-weight: 600;"><?php echo FS_DEFINITE_INVOICE_AU_13;?></td>
        ...
        <tr>
            ...
            <td valign="top">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size: 12px;line-height: 16px;">
                    <tr>
                        <td align="right" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;font-weight: 600;"><?php echo FS_DEFINITE_INVOICE_ES_01;?></td>
                        <td width="30"></td>
                    ...
                    <tr height="8"></tr>
                    <?php if ($ordersData['delivery_country_id'] == 223) {?>
                        <tr>
                            <td align="right" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;font-weight: 600;"><?php echo TEXT_UNKNOWN_TAX_RATE;?></td>
                            <td width="30"></td>
                            <td width="102" style="font-family: Microsoft YaHei, 思源黑体 CN Light;"><?php echo $tax_value ? $tax : 'US$ &nbsp;0.00' ;?></td>
                        </tr>
                        <tr height="8"></tr>
                    <?php }?>
                    <tr>
                        <td align="right" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;font-weight: 600;"><?php echo FS_DEFINITE_INVOICE_AU_17;?></td>
                        <td width="30"></td>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="color: #333;word-wrap: break-word;border-collapse: collapse;">
        ...
        <tr>
            <td width="100%" valign="top">
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="font-size: 12px;line-height: 16px;">
                    <tbody><tr>
                        <td style="font-family: 微软雅黑;font-weight: 600;"><?php echo FS_DEFINITE_INVOICE_ES_02;?></td>
                        <td width="50"></td>
                    </tr>
                    <tr height="14"></tr>
                    <tr>
                        <td style="font-family: 微软雅黑;"><?php echo FS_DEFINITE_INVOICE_ES_03;?></td>
                        <td width="50"></td>
                    </tr>
                    <tr height="4"></tr>
                    <tr>
                        <td style="font-family: 微软雅黑;"><?php echo FS_DEFINITE_INVOICE_ES_04;?></td>
                        <td width="50"></td>
                    </tr>
                    <tr height="4"></tr>
                    <tr>
                        <td style="font-family: 微软雅黑;"><?php echo FS_DEFINITE_INVOICE_ES_05;?></td>
                        <td width="50"></td>
                    </tr>
                    <tr height="4"></tr>
                    <tr>
                        <td style="font-family: 微软雅黑;"><?php echo FS_DEFINITE_INVOICE_ES_06;?></td>
                        <td width="50"></td>
                    </tr>
                    <tr height="48"></tr>
                    </tbody></table>
                    ...
                    <tr style="font-family: Microsoft YaHei, 思源黑体 CN Medium;font-weight: 600;">
                        <td align="right"><?php
                            if($invocie_info['invocie_date'] && $invocie_info['invocie_date']!='0000-00-00 00:00:00'){
                                echo date("m . d . Y",strtotime($invocie_info['invocie_date']));
                            }else{
                                echo '--';
                            }
                            ?></td>
