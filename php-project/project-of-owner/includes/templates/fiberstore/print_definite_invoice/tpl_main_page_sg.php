...
<div style="position: relative;padding: 80px;" class="proforma_invoice">
        ...
        <tr>
            <td valign="top">
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="font-size: 12px;line-height: 16px;">
                    <tr height="18"></tr>
                    <tr>
                        <td width="126" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;font-weight: 600;">
                    ...
                    <tr height="8"></tr>
                    <tr>
                        <td width="160" style="font-family: 微软雅黑;font-weight: 600;">
                            <?php echo FS_DEFINITE_INVOICE_CN_03;?>
                        </td>
    ...
    <table width="100%" border="1" cellpadding="12" cellspacing="0" bordercolor="#6c6d70" style="font-size: 12px;line-height: 16px;border-collapse: collapse;color: #333;word-wrap: break-word;" class="info_table">
        <thead>
        <tr class="print_tr" align="center" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;background-color: #6c6d70;color: #fff;line-height: 12px;">
            <td width="64.47%" style="border: 0;border-right: 1px solid #fff;padding-left: 5px;padding-right: 5px;font-weight: 600;"><?php echo FS_DEFINITE_INVOICE_AU_13;?></td>
            <td width="10.7%" style="border: 0;border-right: 1px solid #fff;padding-left: 5px;padding-right: 5px;font-weight: 600;"><?php echo FS_DEFINITE_INVOICE_AU_14;?></td>
            <td width="10.8%" style="border: 0;border-right: 1px solid #fff;padding-left: 5px;padding-right: 5px;font-weight: 600;"><?php echo FS_DEFINITE_INVOICE_AU_15;?></td>
            <td width="10.8%" style="border: 0;border-right: 1px solid #fff;padding-left: 5px;padding-right: 5px;font-weight: 600;"><?php echo FS_DEFINITE_INVOICE_AU_16;?></td>
            <td style="border: 0;border-right: 1px solid #6c6d70;padding-left: 5px;padding-right: 5px;font-weight: 600;"><?php echo FS_DEFINITE_INVOICE_AU_17;?></td>
        </tr>
        </thead>
        <tbody>
            ...
            <td valign="top">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size: 12px;line-height: 16px;">
                    ...
                    if($cost_data_value['ot_tax']) {
                        if($ordersData['delivery_country_id'] == 188){
                            $vat_pr = '7%';
                        }
                        $ot_tax = $tax;
                    }else{
                        $vat_pr = '0%';
                        $ot_tax = $currencies->total_format(0,true,$ordersData['currency'],$ordersData['currency_value']);
                    }
                    ?>
                    <tr>
                        <td align="right" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;"><?php echo FS_DEFINITE_INVOICE_AU_19;?></td>
                        <td width="30"></td>
                        <td width="95" style="font-family: Microsoft YaHei, 思源黑体 CN Light;"><?php echo $subtotal_all;?></td>
                        <!--负数书写样式-->
                        <!--<td width="95" style="font-family: Microsoft YaHei, 思源黑体 CN Light;">S$ -50.68</td>-->
                    </tr>
                    <tr height="8"></tr>
                    <tr>
                        <td align="right" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;"><?php echo FS_DEFINITE_INVOICE_AU_20;?></td>
                        <td width="30"></td>
                        <td width="95" style="font-family: Microsoft YaHei, 思源黑体 CN Light;"><?php echo $shipping_cost;?></td>
                    </tr>
                    <tr height="8"></tr>
                    <tr>
                        <td align="right" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;"><?php echo FS_DEFINITE_INVOICE_AU_22;?></td>
                        <td width="30"></td>
                        <td width="95" style="font-family: Microsoft YaHei, 思源黑体 CN Light;"><?php echo $totalOrCost;?></td>
                    </tr>
                    <tr height="8"></tr>
                    <tr>
                        <td align="right" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;"><?php echo FS_DEFINITE_INVOICE_SG_01;?></td>
                        <td width="30"></td>
                        <td width="95" style="font-family: Microsoft YaHei, 思源黑体 CN Light;"><?php echo $vat_pr;?></td>
                    </tr>
                    <tr height="8"></tr>
                    <tr>
                        <td align="right" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;"><?php echo FS_DEFINITE_INVOICE_SG_02;?></td>
                        <td width="30"></td>
                        <td width="95" style="font-family: Microsoft YaHei, 思源黑体 CN Light;"><?php echo $ot_tax;?></td>
                    </tr>
                    <tr height="8"></tr>
                    <tr>
                        <td align="right" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;"><?php echo FS_DEFINITE_INVOICE_AU_23;?></td>
                        <td width="30"></td>
                        <td width="95" style="font-family: Microsoft YaHei, 思源黑体 CN Light;"><?php echo $total;?></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size: 12px;line-height: 16px;color: #333;word-wrap: break-word;border-collapse: collapse;">
        <tr height="28"></tr>
        <tr>
            <td style="font-family: Microsoft YaHei, 思源黑体 CN Medium;"><?php echo FS_DEFINITE_INVOICE_AU_24;?></td>
        </tr>
        <tr height="6"></tr>
        <tr>
