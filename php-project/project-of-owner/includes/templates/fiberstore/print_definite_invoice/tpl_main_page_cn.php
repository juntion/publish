...
<div style="position: relative;padding: 80px;" class="proforma_invoice">
        ...
        <tr>
            ...
            <td width="50%">
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr height="33"></tr>
                    <tr>
                        <td width="50%" align="right" valign="bottom" style="font-size: 16px;line-height: 16px;font-family: 'Microsoft YaHei', 思源黑体 CN Medium;font-weight: 600;"><?php echo FS_DEFINITE_INVOICE_CN_01;?></td>
                    </tr>
                </table>
            </td>
        </tr>
        ...
        <tr>
            <td width="57.6%" valign="top">
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="font-size: 12px;line-height: 16px;">
                    ...
                    <tr>
                        ...
                        <td style="font-family: Microsoft YaHei, 思源黑体 CN Light;">
                            ...
                            if($invocie_date && $invocie_date!='0000-00-00 00:00:00'){
                                echo date("Y / m / d",strtotime($invocie_date));
                            }else{
                                echo '--';
                            }
                            ?>
                    ...
                    <tr>
                        <td width="142" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;font-weight: 600;">
                            <?php echo FS_DEFINITE_INVOICE_CN_02;?>
                        </td>
                        <td style="font-family: Microsoft YaHei, 思源黑体 CN Light;">
                            <?php echo $product_invoice_arr['allCleanStatus'] ? FS_DEFINITE_INVOICE_CN_11 : FS_DEFINITE_INVOICE_CN_12; ?>
                        </td>
                    </tr>
                    <tr height="8"></tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="font-family: Microsoft YaHei, 思源黑体 CN Light;">
                            <?php echo $instock_shipping_info['shipping_number'] ?: '--';?>
                        </td>
                    </tr>
                    <tr height="8"></tr>
                    <tr>
                    ...
                    <?php if ($ordersData['delivery_tax_number']) {?>
                    <tr height="8"></tr>
                    <tr>
                        <td width="142" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;font-weight: 600;">
                            <?php echo FS_DEFINITE_INVOICE_CN_04;?>
                        </td>
                        <td style="font-family: Microsoft YaHei, 思源黑体 CN Light;">
                            <?php echo $ordersData['delivery_tax_number'];?>
                        </td>
                    </tr>
                    <?php }?>
                    <tr height="8"></tr>
    ...
    <table width="100%" border="1" cellpadding="11" cellspacing="0" bordercolor="#6c6d70" style="font-size: 12px;line-height: 16px;color: #333;word-wrap: break-word;border-collapse: collapse;">
        ...
        <tr class="print_tr" align="center" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;background-color: #6c6d70;color: #fff;line-height: 13px;">
            <td width="32%" style="border: 0;border-right: 1px solid #fff;padding-left: 5px;padding-right: 5px;font-weight: 600;"> <?php echo FS_DEFINITE_INVOICE_CN_05;?></td>
            <td width="10.7%" style="border: 0;border-right: 1px solid #fff;padding-left: 5px;padding-right: 5px;font-weight: 600;"><?php echo FS_DEFINITE_INVOICE_AU_15;?></td>
            <td width="10.7%" style="border: 0;border-right: 1px solid #fff;padding-left: 5px;padding-right: 5px;font-weight: 600;"><?php echo FS_DEFINITE_INVOICE_AU_16;?></td>
            <td width="10.7%" style="border: 0;border-right: 1px solid #fff;padding-left: 5px;padding-right: 5px;font-weight: 600;"><?php echo FS_DEFINITE_INVOICE_AU_17;?></td>
            <?php if ($product_invoice_arr['isCountry']) {?>
                <td style="border: 0;border-right: 1px solid #6c6d70;padding-left: 5px;padding-right: 5px;font-weight: 600;"><?php echo FS_DEFINITE_INVOICE_CN_06;?></td>
            <?php }?>
        </tr>
        </thead>
        <tbody>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="color: #333;word-wrap: break-word;border-collapse: collapse;">
        ...
        <tr>
            ...
            <td width="33.86%" valign="top">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size: 12px;line-height: 16px;">
                    <tr>
                        <td align="right" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;font-weight: 600;"><?php echo FS_DEFINITE_INVOICE_CN_07;?></td>
                        <td width="30"></td>
                    ...
                    <tr height="8"></tr>
                    <tr>
                        <td align="right" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;font-weight: 600;"><?php echo FS_DEFINITE_INVOICE_CN_08;?></td>
                        <td width="30"></td>
                    ...
                    if($cost_data['ot_tax']){
                        echo '<tr>
                        <td align="right" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;">'. FS_DEFINITE_INVOICE_CN_09 .'</td>
                        <td width="30"></td>
                        <td width="102" style="font-family: Microsoft YaHei, 思源黑体 CN Light;">'.$tax.'</td>
                    </tr>
                    <tr height="8"></tr>';
                    }
                    ?>
                    <tr>
                        <td align="right" style="font-family: Microsoft YaHei, 思源黑体 CN Medium;font-weight: 600;"><?php echo FS_DEFINITE_INVOICE_CN_10;?></td>
                        <td width="30"></td>
        ...
        <tr>
            ...
            <td width="100">
                <table width="100%" border="0" cellpadding="0" style="font-size: 12px;line-height: 14px;">
                    <tr style="font-family: Microsoft YaHei, 思源黑体 CN Medium;font-weight: 600;">
                        <td style="font-weight: 600;" align="right"><?php
                            if($invocie_info['invocie_date'] && $invocie_info['invocie_date']!='0000-00-00 00:00:00'){
                                echo date("Y / m / d",strtotime($invocie_info['invocie_date']));
                            }else{
                                echo '--';
                            }
                            ?></td>
