...
<div class="bottom bottom-fixed">
    ...
    <div class="login-bottom-img">
        <?php
        $img_src = 'includes/templates/fiberstore/images/footer_logo.jpg';
        if(in_array($_SESSION['languages_code'],['de','dn'])){
            $img_src = 'includes/templates/fiberstore/images/footer_logo_de.jpg';
        }
        ?>
        <img src="<?php echo HTTPS_IMAGE_SERVER.$img_src;?>">
    </div>
</div>

<?php //}?>
<?php if( FILENAME_CHECKOUT_SUCCESS == $_GET['main_page']){ ?>
