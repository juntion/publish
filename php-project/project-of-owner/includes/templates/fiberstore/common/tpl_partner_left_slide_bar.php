...
<div class="title_zhenghe">
  <ul>
    ...
    <!--
     ...
     <?php echo ('estimated_lead_time' == $_GET['main_page']) ? 'Estimasted Lead Time': '<a href="'.zen_href_link('estimated_lead_time','').'">Estimasted Lead Time</a>' ;?>
     </li> 
     
     
           <li <?php echo (FILENAME_ISO_STANDARD == $_GET['main_page']) ? 'class="mrxs"' : ''; ?>>
     <?php echo (FILENAME_ISO_STANDARD == $_GET['main_page']) ? 'ISO Standard': '<a href="'.zen_href_link(FILENAME_ISO_STANDARD,'').'">ISO Standard</a>' ;?>
     </li> 
     
     
                <li <?php echo (FILENAME_WARRANTY== $_GET['main_page']) ? 'class="mrxs"' : ''; ?>>
     <?php echo (FILENAME_WARRANTY == $_GET['main_page']) ? 'Warranty Policy': '<a href="'.zen_href_link(FILENAME_WARRANTY,'').'">Warranty Policy</a>' ;?>
     </li> 
