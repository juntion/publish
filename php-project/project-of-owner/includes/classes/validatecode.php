...
//  var_dump($this->font);exit;
  $this->font = 'www.fs.com/includes/classes/font/elephant.ttf';//注意字体路径要写对，否则显示不了图片
 }
 //生成随机码
 ...
 private function createFont() {
  ...
  for ($i=0;$i<$this->codelen;$i++) {
   $this->fontcolor = imagecolorallocate($this->img,mt_rand(0,0),mt_rand(0,0),mt_rand(0,0));
