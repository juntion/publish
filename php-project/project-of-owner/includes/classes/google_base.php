 ...
 * @version $Id: google_base.php 56 2011-05-04 05:45:36Z numinix $
 ...
 */
  ...
  class google_base {
    ...
    function google_base_fwrite($output='', $mode) {
      global $outfile;
      $output = implode("\n", $output);
    ...
    function google_base_version() {
      $file = DIR_FS_CATALOG . 'module_version/google_merchant_center_feeder.txt';
      $handle = fopen($file, 'r');
    ...
    function check_product($products_id) {
      if ($this->included_categories_check(GOOGLE_BASE_POS_CATEGORIES, $products_id) && !$this->excluded_categories_check(GOOGLE_BASE_NEG_CATEGORIES, $products_id) && $this->included_manufacturers_check(GOOGLE_BASE_POS_MANUFACTURERS, $products_id) && !$this->excluded_manufacturers_check(GOOGLE_BASE_NEG_MANUFACTURERS, $products_id)) {
        return true;
      } else {
        return false;
      }
    ...
    function google_base_xml_sanitizer($str) {
      $str = $this->google_base_sanita($str);
      $strout = null;
    ...
    function google_base_image_url($products_image) {
      ...
      if (defined('GOOGLE_BASE_ALTERNATE_IMAGE_URL') && GOOGLE_BASE_ALTERNATE_IMAGE_URL != '') {
        return GOOGLE_BASE_ALTERNATE_IMAGE_URL . $products_image; 
      }
