...
return array (
    ...
    'operations' => array(
        'Search' => array(
            'httpMethod' => 'GET',
            'uri' => AMAZON_ENDPOINT.'/2013-01-01/search?format=sdk&pretty=true',
        ...
        'Suggest' => array(
            'httpMethod' => 'GET',
            'uri' => AMAZON_ENDPOINT.'/2013-01-01/suggest?format=sdk&pretty=true',
            'class' => 'Guzzle\\Service\\Command\\OperationCommand',
        ...
        'UploadDocuments' => array(
            'httpMethod' => 'POST',
            'uri' => AMAZON_ENDPOINT.'/2013-01-01/documents/batch?format=sdk',
            'class' => 'Guzzle\\Service\\Command\\OperationCommand',
