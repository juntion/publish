...
//                                 'loadFile'=>'class.phpbb.php');
  ...
  $autoLoadConfig[0][] = array('autoType'=>'class',
  								'loadFile'=>'category_info.php');
  
  $autoLoadConfig[0][] = array('autoType'=>'class',
  								'loadFile'=>'cacheFactory.php');
  
  $autoLoadConfig[0][] = array('autoType'=>'class',
  								'loadFile'=>'fiberstore_discount.php');
/**
 * Breakpoint 10.
 * 
...
//                                  'loadFile'=> 'init_shipping_redirect.php');
...
//                                  'loadFile'=> 'init_header.php');
  ...
  $autoLoadConfig[210][] = array('autoType'=>'init_script',
    		'loadFile'=> 'init_ajax_request.php');

  
    $autoLoadConfig[230][] = array('autoType'=>'classInstantiate',
                                 'className'=>'fiberstore_discount',
                                 'objectName'=>'fiberstore_products_discount');
    $autoLoadConfig[240][] = array('autoType'=>'init_script',
    		'loadFile'=> 'init_phone_request.php');

    $autoLoadConfig[0][] = array('autoType'=>'class',
        'loadFile'=>'FsSecret.php');
