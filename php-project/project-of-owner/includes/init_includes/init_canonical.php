 ...
 */
  case ($current_page == 'index' && isset($_GET['cPath'])):
    $canonicalLink = zen_href_link(FILENAME_DEFAULT,'cPath='.$current_category_id);
 ...
 */
  case ($this_is_home_page):
    $canonicalLink = preg_replace('/(index.php)(\?)(main_page=)(index)$/', '', zen_href_link(FILENAME_DEFAULT, '', 'SSL', false));
    break;
/**
 ...
 */
 ...
 // categories search 
  case ($current_page == 'products_search' && isset($_GET['categories'])):
  $canonicalLink = zen_href_link(FILENAME_DEFAULT,'cPath='.$_GET['categories']);	
  break;   
    
   // case ($current_page == 'narrow' && isset($_GET['narrow']) && isset($_GET['cPath'])):
    case ($current_page == 'narrow' && isset($_GET['narrow']) && isset($_GET['cPath']) ):
