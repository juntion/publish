...
if (isset($_GET['main_page']) && $_GET['main_page'] == 'index'){	$time_now = time();    $max_age = 60*60*24;    header ("last-modified: " . gmdate ('r', $time_now));    header ("expires: " . gmdate ("r", ($time_now + $max_age)));    header ("cache-control: max-age=".$max_age);}
