 ...
 */
  ...
  if (method_exists($this, '_doRefund')) {
    ...
    $outputRefund .= '<tr style="background-color : #e5e5e5; border-style : dotted;">'."\n";
  ...
  if (method_exists($this, '_doCapt')) {
    ...
    $outputCapt .= '<tr style="background-color : #e5e5e5; border-style : dotted;">'."\n";
  ...
  if (method_exists($this, '_doVoid')) {
    ...
    $outputVoid .= '<tr style="background-color : #e5e5e5; border-style : dotted;">'."\n";
