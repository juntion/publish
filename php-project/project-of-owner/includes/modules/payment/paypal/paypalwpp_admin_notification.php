 ...
 */
  ...
  foreach ($ipn->fields as $key=>$value){
    ...
    $outputStartBlock .= '<td><table class="noprint" style="margin:0 auto;">'."\n";
    $outputStartBlock .= '<tr >'."\n";
    $outputEndBlock .= '</tr>'."\n";
  ...
  if ($response['RESPMSG'] != '') {
    ...
    $outputPayPal .= '<td valign="top"><table class="noprint_table">'."\n";
  ...
  if (method_exists($this, '_doRefund')) {
    ...
    $outputRefund .= '<tr style="background-color : #e5e5e5; ">'."\n";
    ...
    $outputRefund .= MODULE_PAYMENT_PAYPAL_ENTRY_REFUND_PARTIAL_TEXT . '<br/> ' . zen_draw_input_field('refamt', 'enter amount', 'length="8"');
  ...
  if (method_exists($this, '_doAuth') && !isset($response['RESPMSG'])) {
    ...
    $outputAuth .= '<tr style="background-color : #e5e5e5; ">'."\n";
  ...
  if (method_exists($this, '_doCapt')) {
    ...
    $outputCapt .= '<tr style="background-color : #e5e5e5; ">'."\n";
  ...
  if (method_exists($this, '_doVoid')) {
    ...
    $outputVoid .= '<tr style="background-color : #e5e5e5; ">'."\n";
