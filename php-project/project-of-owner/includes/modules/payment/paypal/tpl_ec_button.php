...
<div id="PPECbutton" class="buttonRow">
  <a href="<?php echo zen_href_link('ipn_main_handler.php', 'type=ec', 'SSL', true, true, true); ?>">`</a>
</div>-->
<span class="shopping_ec_paypal">
    <!-- <span>  or  </span> -->
    <a href="<?php echo zen_href_link('paypal_express.php', 'type=ec', 'SSL', true, true, true); ?>"><?php echo FS_BUY_WITH;?> &nbsp;<img src="/images/shopping_ec_paypal.png" alt="FiberStore shopping_ec_paypal.png" title="Paypal"></a>
  </span>
<?php
}
?>
