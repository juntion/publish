...
// class constructor
   function WEBMONEY(){
	   global $order;
		$this->code = 'WEBMONEY';
		if ($_GET['main_page'] != '') {
		   $this->title = MODULE_PAYMENT_WEBMONEY_TEXT_CATALOG_TITLE; 
		}else{
		   $this->title = MODULE_PAYMENT_WEBMONEY_TEXT_ADMIN_TITLE;
		}
       ...
       $this->form_action_url = MODULE_PAYMENT_WEBMONEY_HANDLER;
...
// class methods
   function update_status() {
     ...
     if ( ($this->enabled == true) && ((int)MODULE_PAYMENT_WEBMONEY_ZONE > 0) ) {
       $check_flag = false;
       $check_query = $db->Execute("select zone_id from " . TABLE_ZONES_TO_GEO_ZONES . " where geo_zone_id = '" . MODULE_PAYMENT_WEBMONEY_ZONE . "' and zone_country_id = '" . $order->billing['country']['id'] . "' order by zone_id");
   ...
   function selection() {
     return array('id' => $this->code,
                   'module' => MODULE_PAYMENT_WEBMONEY_TEXT_CATALOG_LOGO,
                   'icon' => MODULE_PAYMENT_WEBMONEY_TEXT_CATALOG_LOGO
                   );
   }
   ...
   function process_button() {
	...
	$payment_result = $myclass->CreateHostedWebMoneyRedirectCheckout($process_string);
   ...
   function after_process() {
	...
	if($status->createdPaymentOutput->payment->statusOutput->statusCode==800){
        ...
        $db->query("insert into globalcollect_payment_status_history set orders_id = '" . $order_id . "',status_id='" . $status_code . "',imformation='" . $response_string . "',description='" . $description . "',datetime='" . date("Y-m-d H:i:s") . "',payment_id='" . $payment_id . "',type=6");
...
//                $db->query("update orders set orders_status = '".$this->processing_status_id."' where orders_id = '".$v."'");
   ...
   function check() {
     ...
     if (!isset($this->_check)) {
       $check_query = $db->Execute("select configuration_value from " . TABLE_CONFIGURATION . " where configuration_key = 'MODULE_PAYMENT_WEBMONEY_STATUS'");
   ...
   function install() {
	 ...
	 if (!defined('MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_1_1')) include(DIR_FS_CATALOG_LANGUAGES . $_SESSION['language'] . '/modules/' . $module_type . '/' . $this->code . '.php');

     $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_1_1 . "', 'MODULE_PAYMENT_WEBMONEY_STATUS', 'True', '" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_1_2 . "', '6', '0', 'zen_cfg_select_option(array(\'True\', \'False\'), ', now())");
     $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_2_1 . "', 'MODULE_PAYMENT_WEBMONEY_SELLER', '".STORE_OWNER_EMAIL_ADDRESS."', '" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_2_2 . "', '6', '2', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_3_1 . "', 'MODULE_PAYMENT_WEBMONEY_MD5KEY', '', '" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_3_2 . "', '6', '4', now())");
     $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_4_1 . "', 'MODULE_PAYMENT_WEBMONEY_PARTNER', '', '" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_4_2 . "', '6', '5', now())");
	  $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_5_1 . "', 'MODULE_PAYMENT_WEBMONEY_ZONE', '0', '" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_5_2 . "', '6', '6', 'zen_get_zone_class_title', 'zen_cfg_pull_down_zone_classes(', now())");
     $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_6_1 . "', 'MODULE_PAYMENT_WEBMONEY_PROCESSING_STATUS_ID', '2', '" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_6_2 . "', '6', '8', 'zen_cfg_pull_down_order_statuses(', 'zen_get_order_status_name', now())");
     $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_7_1 . "', 'MODULE_PAYMENT_WEBMONEY_ORDER_STATUS_ID', '1', '" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_7_2 . "', '6', '10', 'zen_cfg_pull_down_order_statuses(', 'zen_get_order_status_name', now())");
     $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_8_1 . "', 'MODULE_PAYMENT_WEBMONEY_SORT_ORDER', '0', '" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_8_2 . "', '6', '12', now())");
     $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_9_1 . "', 'MODULE_PAYMENT_WEBMONEY_HANDLER', 'https://api.globalcollect.com', '" . MODULE_PAYMENT_WEBMONEY_TEXT_CONFIG_9_2 . "', '6', '18', '', now())");
}

   function remove() {
     global $db;
     $db->Execute("delete from " . TABLE_CONFIGURATION . " where configuration_key LIKE  'MODULE_PAYMENT_WEBMONEY%'");
   }

   function keys() {
     return array(
         'MODULE_PAYMENT_WEBMONEY_STATUS',
         'MODULE_PAYMENT_WEBMONEY_SELLER',
         'MODULE_PAYMENT_WEBMONEY_MD5KEY',
         'MODULE_PAYMENT_WEBMONEY_PARTNER',
         'MODULE_PAYMENT_WEBMONEY_ZONE',
         'MODULE_PAYMENT_WEBMONEY_PROCESSING_STATUS_ID',
         'MODULE_PAYMENT_WEBMONEY_ORDER_STATUS_ID',
         'MODULE_PAYMENT_WEBMONEY_SORT_ORDER',
         'MODULE_PAYMENT_WEBMONEY_HANDLER'
         );
   }
