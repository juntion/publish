...
if (isset($_GET['page_products_count']) && (int)$_GET['page_products_count'] > 0) 
$listing_split = new splitPageResults($listing_sql, $_GET['page_products_count'], 'p.products_id', 'page');
else $listing_split = new splitPageResults($listing_sql, MAX_DISPLAY_PRODUCTS_LISTING, 'p.products_id', 'page');
