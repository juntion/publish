        ...
        <div class="purchaseHelp_content_listbox">
            <div class="purchaseHelp_content_listcont alone_after">
                ...
                <div  class="purchaseHelp_right">
                    <div class="purchaseHelp_right_cont pur_top">
                        <h1 class="purchaseHelp_right_tit top_one1"><?php echo FS_HOW_TO_BUY_03; ?></h1>
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main">
                                ...
                                <ul class="hasDot_ul">
                                    <li><?php echo FS_HOW_TO_BUY_12; ?><a href="<?php echo $code;?>/index.php?main_page=login"><?php echo FS_HOW_TO_BUY_13; ?></a><?php echo FS_HOW_TO_BUY_14; ?><a href="<?php echo $code;?>/index.php?main_page=regist"><?php echo FS_HOW_TO_BUY_15; ?></a>”.</li>
                                    <li><?php echo FS_HOW_TO_BUY_16; ?><a href="<?php echo $code;?>/index.php?main_page=regist"><?php echo FS_HOW_TO_BUY_09; ?></a><?php echo FS_HOW_TO_BUY_17; ?></li>
                                </ul>
                                <p class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_18; ?><a href="<?php echo $code;?>/index.php?main_page=my_dashboard"><?php echo FS_HOW_TO_BUY_03; ?></a><?php echo FS_HOW_TO_BUY_19; ?> </p>
                            </div>
                        </div>
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                ...
                                <ul class="hasDot_ul choosez">
                                    <li><b><a href="<?php echo $code;?>/index.php?main_page=edit_my_account"> <?php echo FS_HOW_TO_BUY_23; ?></a></b><br/>
                                        <?php echo FS_HOW_TO_BUY_24; ?><a href="<?php echo $code;?>/index.php?main_page=manage_orders"><?php echo FS_HOW_TO_BUY_25; ?></a>".</li>
                                    <li><b> <?php echo FS_HOW_TO_BUY_26; ?></b><br/>
                                        <?php echo FS_HOW_TO_BUY_27; ?> "<a href="<?php echo $code;?>/index.php?main_page=edit_my_account"><?php echo FS_HOW_TO_BUY_23; ?></a>". <?php echo FS_HOW_TO_BUY_28; ?> "<a href="<?php echo $code;?>/index.php?main_page=login"><?php echo FS_HOW_TO_BUY_29; ?></a>" <?php echo FS_HOW_TO_BUY_30; ?><?php echo FS_HOW_TO_BUY_32; ?></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                <p class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_36; ?> "<a href="<?php echo $code;?>/index.php?main_page=manage_addresses"><?php echo FS_HOW_TO_BUY_37; ?></a>". <?php echo FS_HOW_TO_BUY_38; ?> "<a href="<?php echo $code;?>/index.php?main_page=my_dashboard"><?php echo FS_HOW_TO_BUY_03; ?></a>" <?php echo FS_HOW_TO_BUY_39; ?> </p>
                        ...
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                ...
                                <ul class="hasDot_ul">
                                    <li><?php echo FS_HOW_TO_BUY_44; ?> "<a href="<?php echo $code;?>/index.php?main_page=my_cases"><?php echo FS_HOW_TO_BUY_45; ?></a>".
                                    </li>
                                    <li><?php echo FS_HOW_TO_BUY_46; ?></li>
                                    <li><?php echo FS_HOW_TO_BUY_47; ?> "<a href="<?php echo $code;?>/index.php?main_page=my_cases"><?php echo FS_HOW_TO_BUY_45; ?></a>".</li>
                                    <li><?php echo FS_HOW_TO_BUY_48; ?><a href="<?php echo $code;?>/customer_service.html"><?php echo FS_HOW_TO_BUY_49; ?></a>".
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="purchaseHelp_right_cont">
                        ...
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                ...
                                <p class="purchaseHelp_right_txt1"><?php echo FS_HOW_TO_BUY_68; ?><a href="<?php echo $code;?>/shipping_delivery.html"> <?php echo FS_HOW_TO_BUY_69; ?></a></p> 
                            </div>
                        </div>
                        <div class="pur_qa_con">
                        ...
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                <p class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_76; ?> <a href="<?php echo $code;?>/index.php? main_page=manage_orders"><?php echo FS_HOW_TO_BUY_77; ?></a> - <?php echo FS_HOW_TO_BUY_78; ?> </p>
                        ...
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                <p class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_84; ?> <a href="<?php echo $code;?>/index.php?main_page=manage_orders"><?php echo FS_HOW_TO_BUY_77; ?></a>.</p>
                    ...
                    <div class="purchaseHelp_right_cont">
                        ...
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                ...
                                <p class="purchaseHelp_right_txt1"><?php echo FS_HOW_TO_BUY_89; ?> <a href="<?php echo $code;?>/payment_methods.html"><?php echo FS_HOW_TO_BUY_90; ?></a>. </p>
                            </div>
                        </div>
						<div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
								...
								<p class="purchaseHelp_right_txt1"><?php echo FS_HOW_TO_BUY_162; ?> <a href="<?php echo $code;?>/shipping_delivery.html"><?php echo FS_HOW_TO_BUY_163; ?></a></p>
                            </div>
                        </div>
						<div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
								...
								<p class="purchaseHelp_right_txt1"><?php echo FS_HOW_TO_BUY_168; ?> <a href="<?php echo $code;?>/shipping_delivery.html"><?php echo FS_HOW_TO_BUY_169; ?></a></p>
                            </div>
                        </div>
                            ...
                            <div class="pur_qa_con_main choosez">
                                <ul class="hasDot_ul choosez">
                                    <li><b><?php echo FS_HOW_TO_BUY_92; ?></b><br/>
                                        <?php echo FS_HOW_TO_BUY_93; ?> ''<a href="<?php echo $code;?>/index.php?main_page=manage_orders"><?php echo FS_HOW_TO_BUY_94; ?></a>'' <?php echo FS_HOW_TO_BUY_95; ?>
                                    </li>
                        ...
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                <p class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_99; ?> <a href="<?php echo $code;?>/partner.html"><?php echo FS_HOW_TO_BUY_100; ?></a>, <?php echo FS_HOW_TO_BUY_101; ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="purchaseHelp_right_cont">
                        ...
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                ...
                                <p  class="purchaseHelp_right_txt1"><?php echo FS_HOW_TO_BUY_110; ?> <a href="<?php echo $code;?>/shipping_delivery.html"><?php echo FS_HOW_TO_BUY_111; ?></a>. </p>
                            </div>
                        </div>
                        <div class="pur_qa_con">
                    ...
                    <div class="purchaseHelp_right_cont">
                        ...
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                <p class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_120; ?> <a href="<?php echo zen_href_link('solution_support'); ?>"> </p>
                            </div>
                        </div>
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                ...
                                <p  class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_126; ?> "<a href=" <?php echo $code;?>/index.php?main_page=inquiry_list"><?php echo FS_HOW_TO_BUY_127; ?></a>". <?php echo FS_HOW_TO_BUY_128; ?></p>
                            </div>
                        </div>
                        <div class="pur_qa_con">
                        ...
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                ...
                                <p class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_133; ?> "<a href="<?php echo $code;?>/index.php?main_page=manage_orders"><?php echo FS_HOW_TO_BUY_77; ?></a>" <?php echo FS_HOW_TO_BUY_134; ?>   </p>
                            </div>
                        </div>
                    </div>
                    <div class="purchaseHelp_right_cont">
                        ...
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                ...
                                <p class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_137; ?> <a href="<?php echo zen_href_link('fs_single_pages','name=day_return_policy','SSL');?>"><?php echo FS_HOW_TO_BUY_138; ?></a> <?php echo FS_HOW_TO_BUY_139; ?></p>
                            </div>
                        </div>
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                ...
                                <p class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_142; ?> "<a href="<?php echo zen_href_link('fs_single_pages','name=warranty','SSL');?>"><?php echo FS_HOW_TO_BUY_143; ?></a>" <?php echo FS_HOW_TO_BUY_144; ?></p>
                            </div>
                        </div>
                        <div class="pur_qa_con">
                    ...
                    <div class="purchaseHelp_right_cont">
                        ...
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                ...
                                <p class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_152; ?> <a href="<?php echo $code;?>/index.php?main_page=account_newsletters"><?php echo FS_HOW_TO_BUY_153; ?></a>.</p>
                            </div>
                        </div>
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                <p class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_155; ?> <a href="<?php echo $code;?>/index.php?main_page=service_feedback"><?php echo FS_HOW_TO_BUY_156; ?></a> <?php echo FS_HOW_TO_BUY_157; ?> </p>
                            </div>
                        </div>
                    </div>
                </div>
...
$(function(){
    var _this;
	var _Height;
	var _height = $('.purchaseHelp_left_fix').offset().top+20; 
	var heightL = $('.purchaseHelp_left').height();
	var _heightR = $('.purchaseHelp_right').height();
	var heightLT = $('.purchaseHelp_left').offset().top;
	var heightR = $('.purchaseHelp_right').height()+$('.purchaseHelp_right').offset().top;
	$(window).bind("scroll", function(){
		var top = $(this).scrollTop();
		var max_height = $('.footer').offset().top - $('.purchaseHelp_left_fix').height();
		var max_height2 = $('.footer').offset().top - $('.purchaseHelp_left_fix').height();

		$('.purchaseHelp_right_cont').each(function(){
			var $ttop = $(this).offset().top-100;
			if(top>=$ttop){
				var index = $(this).index();
				$('.purchaseHelp_left li').eq(index).addClass('choosez').siblings().removeClass('choosez');
			}
		})
		if ($(window).scrollTop() > heightLT) {
			if(heightR >= $(window).scrollTop()+heightL){
				$('.purchaseHelp_left_fix').css({"position":"fixed","top":"20px","margin-top":0}).addClass('choosez')    
			}else{
				$('.purchaseHelp_left_fix').css({"position":"relative","margin-top":_heightR-heightL+'px',"top":"0px"}).removeClass('choosez')
			}
		}else{
			$('.purchaseHelp_left_fix').css({"position":"relative","top":"0px"})
		}
	...
	$('.purchaseHelp_right_cont').each(function(){
		...
		if(top>=$ttop){
			var index = $(this).index();
			$('.purchaseHelp_left_list li').eq(index).addClass('choosez').siblings().removeClass('choosez');
		}
	})
    ...
    $('.purchaseHelp_left_li').on('click',function(e){
        ...
        var height = $('.purchaseHelp_right_cont').eq(_index).offset().top;
        $('html,body').animate({
            scrollTop: height
        }, 500);
    })
