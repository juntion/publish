<?php
  ...
  define('MODULE_PAYMENT_ECHECK_RECEIVER_FIRST_NAME', 'First Name');
  ...
  define('MODULE_PAYMENT_ECHECK_TEXT_TITLE', 'Electronic Check');
  ...
  define('MODULE_PAYMENT_ECHECK_ACCEPTANCE_MARK_TEXT', 'Send Money with echeck');
