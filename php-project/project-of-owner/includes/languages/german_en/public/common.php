...
define('COMMON_SERVICE_17','Excellent Team Show');
define('COMMON_SERVICE_18','FS never say no to good inspiration from employees and always encourage every single person to speak their ideas out . That\'s the reason');
define('COMMON_SERVICE_19','why FS can serve our customers around the world better and better.');
define('COMMON_SERVICE_20','Get  Started');
...
define("FS_YAO1","Question? We are here 24/7");
...
// 2018.7.5/7.14 小语种/英文新版首页上线 fairy 新版 新增
define("FS_FOOTER_COPYRIGHT",'Copyright © 2009-YEAR '.FS_LOCAL_COMPANY_NAME.', NOVA Gewerbepark, Gebäude 7, Am Gfild 7, 85375 Neufahrn, Deutschland.');
define("FS_FOOTER_COPYRIGHT_M","Copyright © 2009-YEAR <span>".FS_LOCAL_COMPANY_NAME."</span>, NOVA Gewerbepark, Building 7, Am Gfild 7, 85375 Neufahrn, Germany.");

define("NEW_FOOTER_05",'Shipping Partners:');
define("NEW_FOOTER_06",'Payment Methods:');
...
//2018.11.29  社交图标上展示Follow us只有au、uk、de/en 展示
define('FS_FOOTER_FOLLOW_US','Follow us');
define('FS_FOOTER_HELP_CENTER','Customer Service');
define('FS_FOOTER_RETURN_POLICY','Return Policy');
...
// common/header.php文件
/* tpl_header.php */
// Make by Frankie  2016-8-19 在线聊天html代码 - 旧，现在可能不用了
// 2018.7.5/7.14 小语种/英文新版首页上线 fairy 整理

// 配置文件 start
define('FS_SITE_UNIQUE_LANGUAGE_ID','11');
// 配置文件 end
...
define('FS_PHONE_DE','+49 8165 7076169');		// Germany
...
define('META_TAGS_SAVED_ITEMS_DESCRIPTION', 'After you add items to cart, click "Save Basket" to save collections of items. You can create as many saved carts as you would like, and you can use saved baskets for repeated orders.');
...
define('FS_HEADER_NEWS','Legal Notice');
...
define('FS_HEADER_NEWS_DES','<dd>This legal notice provides gerneral information about FS.</dd>');
define('FS_HEADER_NEWS_READ_MORE','<a class="home_solution_sub_level_right_dd_a" href="'.reset_url('legal_notice.html').'"><span>Learn more</span><i class="iconfont icon">&#xf089;</i></a>');
