...
define('FS_SUCCESS_HSBC','Sparkasse Freising');
define('FS_SUCCESS_AC_NAME','Beneficiary A/C Name');
define('FS_SUCCESS_CO',FS_DE_COMPANY_NAME);
...
define('FS_SUCCESS_OUR','Account Number');
...
define("FS_SUCCESS_PURCHASE_ADDRESS_NOTE","The shipping address does not match that on your credit application form. Please upload your purchase order to help us review it. The result will be emailed to you within 12 hours.");
define("FS_SUCCESS_PURCHASE_MONEY_NOTE","The order amount exceeds your credit limit in FS.COM. To get this order processed quickly, please pay off the previous orders to revolve credit limit, or you can go to <a href ='index.php?main_page=my_dashboard'>”My account”</a> and click “Purchase Order” to apply for increasing your credit limit, we will email you the result after a review.");
define("FS_SUCCESS_PURCHASE_DOUBLE_NOTE","The shipping address does not match addresses on your credit application form and the order amount exceeds your credit limit in FS.COM.This order will need review.To get this order processed quickly, please pay off the previous orders to revolve credit limit, or you can go to <a href ='index.php?main_page=my_dashboard'>”My account”</a> and click “Purchase Order” to apply for increasing your credit limit, we will email you the result after a review.");
...
define('FS_CHECKOUT_SUCCESS_CHAT','If any question, please call us '.FS_PHONE_DE.' or email us');
//2017.10.5 add  by frankie
define("FS_SUCCESS_GLOABL_THANK","Payment is successful! Your order is in process.");
...
define('FS_SUCCESS_ORDER_CONFIRM_DATE', 'Order confirm Date');
...
define('FS_CHECKOUT_SUCCESS_NEW_17', 'Your order will be delivered between 9:00am and 5:00pm, Monday to Friday (excluding public holidays). Someone will need to be at the nominated address to accept and sign for delivery.');
