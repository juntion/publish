...
define('FS_SFP_OPTICAL15','Learn more about FS.COM test center');

define('FS_SFP_OPTICAL16','Why FS.COM CWDM/DWDM SFP+ Series Fiber Optic Transceivers?');
define('FS_SFP_OPTICAL17','Professional Test Equipments');
...
define('FS_SFP_OPTICAL33','What Can We Help You?');
...
define('FS_SFP_OPTICAL60','FS.COM transceivers must experience a series of testing procedures in our test center, including performance testing, programming process and on-device testing, to guarantee its quality and practical performance on intended devices.');

define('FS_SFP_OPTICAL61',"FS.COM provide a full series and large inventories of DWDM/CWDM SFP+ transceivers, such as 10G DWDM SFP+ 80km, 10G DWDM SFP+ 40km, 10G CWDM SFP+ 80km, 10G CWDM SFP+ 40km, 10G CWDM SFP+ 10km. Holding a large inventory of popular transceivers in our four local warehouses in Europe, North America, Asia, and Oceania, FS.COM is available to ensure the same-day shipping after receiving customers' online orders.");
