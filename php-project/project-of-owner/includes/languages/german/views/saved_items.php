...
define('FS_CART_SAVE','Sparen Sie:');
...
define('FS_TAXES',' (exkl. Versandkosten und Steuern)');
...
//2018 //1.25.Ternence
define('FS_SHOP_CART_ALERT_JS_4','Alle gespeicherte Artikel nachsehen');
define('FS_SHOP_CART_ALERT_JS_5','Warenkorb speichern');
define('FS_SHOP_CART_ALERT_JS_6','Gespeicherter Einkaufswagen kann problemlos auf allen Geräten gemeinsam geteilt werden und verbleiben auf der Website, bis Sie den Wagen entfernen. Artikel werden nur entfernt, wenn sie nicht mehr verfügbar sind.');
define('FS_SHOP_CART_ALERT_JS_7','Name Ihres gespeicherten Einkaufswagens:');
define('FS_SHOP_CART_ALERT_JS_8','Nein');
...
define('FS_SHOP_CART_ALERT_JS_11','Einkaufswagen zurückgehen');
define('FS_SHOP_CART_ALERT_JS_12','Den Einkaufswagen teilen');
define('FS_SHOP_CART_ALERT_JS_16','Senden Sie mir eine Kopie dieser E-Mail.');
define('FS_SHOP_CART_ALERT_JS_17','Stornieren');
define('FS_SHOP_CART_ALERT_JS_18','Die gespeicherte Artikel stornieren');
...
//Items
define('FS_SHOP_CART_ALERT_JS_21','Alle gespeicherte Warenkörbe');
define('FS_SHOP_CART_ALERT_JS_22','Den Artikel speichern');
define('FS_SHOP_CART_ALERT_JS_23','Es gibt noch keine gespeicherte Artikel.');
...
define('FS_SHOP_CART_ALERT_JS_27','Nachdem Sie Artikel zum Warenkorb hinzugefügt haben, klicken Sie auf „Warenkorb speichern“, um die Artikel zu speichern.');
define('FS_SHOP_CART_ALERT_JS_28','Gespeicherte Warenkörbe bleiben auf der Webseite für die weitere Verwendung, bis Sie sie löschen. Sie können mehrere gespeicherte Warenkörbe nach Ihrer Anforderung erstellen, und Sie können gespeicherte Warenkörbe für die Artikel wieder bestellen.');
...
define('FS_SHOP_CART_ALERT_JS_36','Alle in den Warenkorb verschieben');
...
define('FS_SHOP_CART_ALERT_JS_41','Wir haben diese E-Mail in Ihrem Namen erfolgreich gesendet. Wenn Sie diese Liste an einen neuen Empfänger senden möchten, klicken Sie bitte auf');
define('FS_SHOP_CART_ALERT_JS_42','Sehen alle');
define('FS_SHOP_CART_ALERT_JS_43','Ihre E-Mail-Adresse eingeben');
define('FS_SHOP_CART_ALERT_JS_44','Ihren Namen eingeben');
...
define("FS_SELECT_CART_ITEMS",'Den gespeicherten Warenkorb auswählen');

define('FS_SAVED_ITEM_01','Einkaufswagen');