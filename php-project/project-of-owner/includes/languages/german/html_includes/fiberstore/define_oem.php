...
.categories_select ul li a { color:#fff; font-size:16px; text-align:center; display:block; text-decoration:none; height:200px!important; line-height:200px!important;padding:0;}
.categories_select ul li span { background-color:rgba(0, 0, 0, 0.3); padding:10px 10px;}
...
<div class="oem_customs_con">
  ...
  <div class="categories_select">
    <ul>
      <li class="select01"><a href="http://www.fs.com<?php echo $code;?>/c/data-center-solutions-1308" target="_blank"><span><?php echo FS_OEM_CLOUD;?></span></a></li>
      <li class="select02"><a href="http://www.fs.com<?php echo $code;?>/support/custom-wdm-otn-solutions-for-long-haul-applications-100" target="_blank"><span><?php echo FS_OEM_TRANSMISSON;?></span></a></li>
      <li class="select03"><a href="http://www.fs.com<?php echo $code;?>/Enterprise-Networks.html" target="_blank"><span><?php echo FS_OEM_ACCESS;?></span></a></li>
    </ul>
  </div>
  <div class="ccc"></div>
