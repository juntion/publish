...
define('BUTTON_CREATE_ACCOUNT_ALT', 'Registrieren');
define('BUTTON_LOG_OFF_ALT', 'Abmelden');
define('BUTTON_ADD_TO_CART_ALT', 'In den Einkaufswagen');
define('BUTTON_ADD_ADDRESS_ALT', 'Neue Adresse hinzufügen');
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT','Ausgewählte Produkte zum Einkaufwagen hinzufügen');
define('BUTTON_BACK_ALT', 'Zurück');
define('BUTTON_BUY_NOW_ALT', 'Kaufen jetzt');
define('BUTTON_CANCEL_ALT', 'stornieren');
define('BUTTON_CHANGE_ADDRESS_ALT', 'Adresse ändern');
define('BUTTON_CHECKOUT_ALT', 'Bezahlen');
define('BUTTON_CONFIRM_SEND_ALT', 'Geschenkegutschein versenden');
define('BUTTON_CONFIRM_ORDER_ALT', 'Bestellung bestätigen');
define('BUTTON_CONTINUE_ALT', 'fortsetzen');
define('BUTTON_CONTINUE_SHOPPING_ALT', 'Einkauf fortsetzen');
define('BUTTON_DELETE_ALT', 'Löschen');
define('BUTTON_DELETE_SMALL_ALT', 'Löschen');
define('BUTTON_DOWNLOAD_ALT', 'Löschen jetzt');
define('BUTTON_EDIT_SMALL_ALT', 'bearbeiten');
define('BUTTON_IN_CART_ALT', 'In den Einkaufswagen');
define('BUTTON_LOGIN_ALT', 'Anmelden ');
define('BUTTON_NEXT_ALT', 'Nächst');
define('BUTTON_PREVIOUS_ALT', 'Vorheriges');
define('BUTTON_REDEEM_ALT', 'einlösen');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Zurück zur Produkteliste');
define('BUTTON_REVIEWS_ALT', 'Zur Seite der Kommentare zu gehen');
define('BUTTON_SEARCH_ALT', 'Suchen');
define('BUTTON_SEND_ALT', 'Versenden jetzt');
define('BUTTON_SEND_ANOTHER_ALT', 'Einen anderen Geschenkgutschein versenden');
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Einen Geschenkgutschein versenden');
define('BUTTON_SHIPPING_ESTIMATOR_ALT', 'Versandkostenrechner');
define('BUTTON_SOLD_OUT_ALT', 'Ausverkauft');
define('BUTTON_SOLD_OUT_SMALL_ALT', 'Ausverkauft');
define('BUTTON_SUBMIT_ALT', 'Informationen einreichen');
define('BUTTON_TELL_A_FRIEND_ALT', 'Einem Freund Bescheid sagen');
define('BUTTON_TELLAFRIEND_ALT', 'Einem Freund Bescheid sagen');
define('BUTTON_UNSUBSCRIBE', 'Abbestellen');
define('BUTTON_UPDATE_ALT', 'Aktualisieren');
define('BUTTON_VIEW_SMALL_ALT', 'Anzeigen');
define('BUTTON_WRITE_REVIEW_ALT', 'Einen Kommentar verfassen');
define('BUTTON_READ_REVIEWS_ALT', 'Diesen Kommentar lesen');
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Nähre Informationen über dieses Produkt erfahren');
define('BUTTON_MORE_REVIEWS_ALT', 'Weitere Kommentare lesen');
?>