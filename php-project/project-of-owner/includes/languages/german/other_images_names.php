...
define('OTHER_BOX_NOTIFY_REMOVE_ALT', 'Diese Benachrichtigung dieses Produktes beseitigen.');
define('OTHER_BOX_NOTIFY_YES_ALT', 'Informieren mich über die Updates von diesem Produkt.');
define('OTHER_BOX_WRITE_REVIEW_ALT', 'Einen Kommentar über diesem Produkt verfassen.');
define('OTHER_CALL_FOR_PRICE_ALT', 'Bitte rufen Sie an für den aktuellen Preis.');
define('OTHER_DOWN_FOR_MAINTENANCE_ALT', 'Zurzeit ist diese Seite für Instandhaltung ausgeschaltet. Bitte kommen Sie später zurück.');
define('OTHER_TRANPARENT_ALT', '');
define('OTHER_IMAGE_CUSTOMERS_AUTHORIZATION_ALT', 'Warten auf die Zustimmung der Kunde ...');
