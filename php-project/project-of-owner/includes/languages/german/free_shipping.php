...
define('FIBERSTORE_TUTORIAL_MORE', 'Mehr');
...
/**************************************/
define('TEXT_FIBERSTORE_REGIST_RESPECTS','FS.COM respektiert Ihre Privatsphäre. Wir werden niemandem Ihre private Informationen mieten oder verkaufen.');
...
define('ACCOUNT_FOOTER_SECURE','GARANTIERT.');
...
define('ACCOUNT_FOOTER_SHOP','Wenn Sie unzufrieden mit dem bei FiberStore Co.Ltd gekauften Produkt, können Sie das Produkt in seiner Originalbedingung innerhalb sieben Tagen für eine Erstattung zurückgeben. Wir werden auch für die Lieferung der Rücksendung zahlen!');
