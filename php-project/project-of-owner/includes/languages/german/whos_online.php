...
define('BOX_WHOS_ONLINE_THEREIS', 'Zurzeit gibt es');
define('BOX_WHOS_ONLINE_THEREARE', 'Zurzeit gibt es');
define('BOX_WHOS_ONLINE_GUEST', 'Busucher');
define('BOX_WHOS_ONLINE_GUESTS', 'Besuchern');
