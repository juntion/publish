<?php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. Powered by <a href="http://www.zen-cart.cn" target="_blank">Zen Basket</a>');
 ...
 // define('FIBERSTORE_REGIST_ERROR','Our system already has a record of that email address - please try logging in with that email address. If you do not use that address any longer you can correct it in the My Account area.');
  ...
  define('FS_FSCOM','https://www.fs.com/au');
...
// Define the name of your Gift Certificate as Gift Voucher, Gift Certificate, Zen Basket Dollars, etc. here for use through out the shop
...
// success messages for added to basket when display basket is off
// set to blank for no messages
// for all pages except where multiple add to basket is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCT', 'Successfully added Product to the basket ...');
// only for where multiple add to basket is used:
...
// multiple product add to basket
...
// table headings for basket display and upcoming products
...
define('FS_THEA_CTUAL_SHIPPING_TIME','We are always devoted to offering the fastest delivery. Learn more about <a href="/au/shipping_delivery.html">delivery information</a>.');
...
define('FS_CHECK_OUT_STATE','Please select state');
...
define('EMAIL_CHECKOUT_COMMON_VAT_COST','GST/Tax');
define('EMAIL_CHECKOUT_COMMON_VAT_COST2','GST/Tax');
define('EMAIL_CHECKOUT_COMMON_VAT_COST_FR','GST/Tax');
...
define('FS_HEADER_FREE_SHIPPING_US_TIP','Free shipping on orders of Eligible Items over US$ 79');
...
define('FS_HEADER_FREE_SHIPPING_AU_TIP','Free Delivery on Orders of Eligible Items over A$99');
...
define('FS_HEADER_FREE_SHIPPING_NZ_TIP','Same Day Shipping on a Broad Selection of Stock Items');
define('FS_FOOTER_FREE_SHIPPING_NZ_TIP','Same Day Shipping');

define('FS_M_FREE_SHIPPING_DE_TIP','Free Delivery on Orders over $MONEY');
define('FS_M_FREE_SHIPPING_NZ_TIP','Fast Shipping to New Zealand');
...
define('FS_M_SHIPPING_US_TIP','Free Delivery on Orders over US$ 79');
...
// au
define('FS_EMAIL_FSCOM','https://www.fs.com/au/');
...
define('FS_EMAIL_URL_1','http://www.fs.com/privacy_policy.html');
/*
 * 客户分享产品邮件
 */
...
define('FS_EMAIL_PRODUCT_SHARE10','https://www.fs.com/');
...
define('FS_EMAIL_TO_US_URL','https://www.fs.com/customer_service.html');
...
define('FS_EMAIL_MY_ACCOUNT_URL','http://www.fs.com/customer_service.html');
...
define('FS_PRODUCTS_CUSTOMIZED','Customised');
...
define('FS_COMMON_WAREHOUSE_CN_RMA','FS.COM Limited <br>
...
define('FS_COMMON_WAREHOUSE_RU','《FiberStore.COM》Ltd.<br>
            ...
            Tel: +7 (499) 643 4876');
define("QTY_SHOW_ZERO","pc in stock");
...
define("QTY_SHOW_ZERO_STOCK_3","pcs in Oversea Warehouses");
...
define("FS_QTY_CHANGED","Please complete your payment ASAP so that your order can be handled at the first time. Otherwise your order might be delayed on delivery due to the change of stock.");
...
define('FS_COMMON_TT_BANK_DE','<table cellspacing="0" cellpadding="5" border="0" class="m_yh_information">
						  ...
						  <tr>
							<td>Bank Address: </td>
							<td><b>230 Swanston St, Melbourne, VIC, 3000</b></td>
						  </tr>
					  </table>');
...
define("FS_HSBC_INFO7","Account Name");
define("FS_HSBC_INFO8","FS.COM PTY LTD");
define("FS_HSBC_INFO9","BSB");
define("FS_HSBC_INF10","013160");
define("FS_HSBC_INF11","Account No.");
define("FS_HSBC_INF12","416794959");
define("FS_HSBC_INF13","SWIFT Code");
define("FS_HSBC_INF14","ANZBAU3M");
define("FS_HSBC_INF15","Bank Address");
define("FS_HSBC_INF16","230 Swanston St, Melbourne, VIC, 3000");
...
define('FS_COMMON_CUSTOMIZED','Customised');
// 公共的
...
define('FS_FOOTER_COOKIE_MOBILE_TIP','We use cookies to offer you a better shopping experience. View  <a href="'.HTTPS_SERVER.reset_url('policies/privacy_policy.html','SSL').'">Cookie Policy</a>.');
...
define("FS_JS_TIT_CHECK8","Contact Number");
...
define('MY_CASE_UPLOAD_17','https://www.fs.com/');
...
//change 2018.4.28
define("FS_FOR_FREE_SHIPPING","Free Delivery ");
...
define("FS_FOR_FREES_SHIPPING_FIVE_CA_UP","Get it within 1-3 business days  when you order by <span>4pm(PST)</span>.");
define("FS_FOR_FREES_SHIPPING_FIVE_MX_UP","Get it within 1-3 business days  when you order by <span>4pm(PST)</span>.");
...
if (get_warehouse_by_code($_SESSION['countries_iso_code']) == 'cn' || $_SESSION['countries_iso_code'] == 'nz') {
    ...
    define('FS_PRE_PRODUCTS_SHIPPING_WD_INFO', "To qualify for free delivery, add at least A$399 (excluding GST) Pre-Order items to your shopping basket. Any Pre-Order item with 'FREE Delivery' on this page is eligible. Orders delivered to remote cities can't enjoy the free delivery service.");
...
define("FS_DISPATCH_WAREHOUSE"," dispatched from AU Warehouse");
//修改2018.5.8
...
define('FS_PRODUCT_INFO_TAX',"(Including 10% <a href='https://www.fs.com/au/information/shipping_delivery.html' target='_blank'>GST</a>)");
...
define("FS_FESTIVAL1","Public Holiday in Germany on");
...
define("FS_FESTIVAL6","Public Holiday in U.S. on");
define("FS_FESTIVAL7"," to process orders dispatched from Seattle Warehouse.");
...
define('FS_SHOP_CART_ALERT_JS_31','Select Basket:');
...
if($_SESSION['countries_iso_code'] == 'nz'){
    ...
    define('FS_SHOP_CART_ALERT_JS_54',' (Shipping and GST not included)');
}
...
define("FS_SHOP_CART_VAT_COST","Estimate GST : ");
define("FS_SHOP_CART_TOTAL","Total (GST included) : ");

define('FS_LOGIN_REGIST_AGREE_PRIVACY',"By clicking the button below, you agree to FS.COM's <a href=\"privacy_policy.html\">Privacy Policy</a> and <a href=\"terms_of_use.html\">Term of Use</a>.");
...
define("FS_COMMON_CHECKOUT_HSBC","Usually funds will be received between 1-3 working days. We will deal with the order once remittance confirmed.");
...
define('FS_SUCCESS_YOUR_NEXT','Your next step is to complete your Wire Transfer payment and submit your payment details.');
define('FS_SUCCESS_WIRE','Direct Deposit');
define('FS_SUCCESS_ORDER','Print Order');
define('FS_SUCCESS_DETAIL','Wire Transfer beneficiary details');
...
define("FS_LIVE_CHAT_CHECKOUT","Get help.  <a target='_blank' href='".reset_url('service/fs_support.html')."'>Live Chat</a> or call");
...
define('FS_PRINT_ORDER_BANK','Direct Deposit');
...
define('FS_CANCEL_ORDER_4',"If you have any questions, please <a href='".zen_href_link('contact_us')."'>contact us</a>. Hope to see you again soon!");
//首页 give feedback
...
define("FS_CHECKOUT_NEW33","Direct Deposit");
...
define("FS_US_NOTICE","FS U.S. Warehouse located in Delaware, supports fast same day shipping. <a  target='_blank' href=".zen_href_link("shipping_delivery","","SSL").">Read more</a>");
define("FS_US_UP_NOTICE","FS U.S. Warehouses located in Delaware, supports fast same day domestic shipments within Contiguous U.S., Alaska, Hawaii, APO/FPO military addresses and Puerto Rico, etc, and international shipments to Canada, Mexico.  <a  target='_blank' href=".zen_href_link("shipping_delivery","","SSL").">Read more</a>");
define("FS_US_OTHER_NOTICE","FS U.S. Warehouses located in Seattle & Delaware respectively, supports fast same day shipments to United States, Canada, and Mexico.  <a  target='_blank' href=".zen_href_link("shipping_delivery","","SSL").">Read more</a>");
define("FS_US_UP_OTHER_NOTICE","FS U.S. Warehouses located in Delaware, supports fast same day shipments to United States, Canada, and Mexico.  <a  target='_blank' href=".zen_href_link("shipping_delivery","","SSL").">Learn more</a>");
...
define('FS_PRODUCT_OFF_TEXT_5','*Some of the items in this order cannot be added to the shopping basket.');
...
define('FS_PRODUCT_OFF_TEXT_8','An item in your Basket is unavailable. It will not show when you proceed to checkout.');
define('FS_PRODUCT_OFF_TEXT_9','These items in your Basket are unavailable. It will not show when you proceed to checkout.');
//清仓产品气泡,提示
...
define("CULUMS_OFF54","Copyright &copy; 2009-".date('Y',time())." FS.COM PTY LTD All Rights Reserved.");
...
define("FS_CHECKOUT_NEW28","Copyright &copy; 2009-".date('Y',time())." FS.COM PTY LTD All Rights Reserved.");
...
//分享购物车
define('FS_SEND_EMAIL_108',"Share Basket List");
define('FS_SEND_EMAIL_109',"Your friend ");
define('FS_SEND_EMAIL_110'," shared a basket list with you.");
define('FS_SEND_EMAIL_111',"Your friend ");
define('FS_SEND_EMAIL_112'," shared a basket list with you. You can click button below to view complete details and add to your own basket list.");
define('FS_SEND_EMAIL_113',"Basket List");
...
define('FS_SEND_EMAIL_122'," shared you a basket list");
//分享产品
...
define('FS_CONTINUE_TO_CART','Continue to Basket');
...
define('FS_ACCOUNT_NEW_07','Most Recent Order');
...
define('FS_ACCOUNT_NEW_11','Most Recent Quote');
...
define("FS_BUSINESS_ACCOUNT_10",'+61 3 9693 3488');
define("FS_BUSINESS_ACCOUNT_11",'au@fs.com');
...
define('FS_LOCAL_COMPANY_NAME','FS.COM Pty Ltd');
...
//购物车登陆且为空的状态 添加save basket入口
define('FS_SAVE_CART_ENTRANCE','Continue shopping on FS or view your <a href="'.zen_href_link('saved_items','type=saved_carts','SSL').'">Saved Baskets</a>.');
...
//au产品QC版块
define("FS_QC_PRODUCT_INFO","(we're still doing the verification to meet the Australian Standard, currently not RCM labelled), established an");
define("FS_QC_PRODUCT_INFO_1","(we're still doing the verification to meet the RCM compliance), established an");
...
define("FS_INQUIRY_LIST_19",'Add to Basket');
...
define("FS_SOLUTION_CUSTOMIZED",'Add to Basket');
...
define('FS_CHECKOUT_ERROR_001',"You've reached the maximum units allowed for the purchase of above items. All available products are added into the basket.");
...
define('FS_CHECKOUT_FOOTER_NEW_07', 'Shopping Basket');
...
define("FS_QUOTE_INQUIRY_17", "Print Shopping Basket");
...
define('FS_PRODUCT_COMMUNITY_06', 'How to Connect FS Switch with Cisco Switch');
define('FS_PRODUCT_HIGHLIGHTS_01', 'Product Highlights');
