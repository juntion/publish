...
define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. Powered by <a href="http://www.zen-basket.cn" target="_blank">Zen Cart</a>');
...
if(SUMMER_TIME){
    ...
    define('FS_SUMMER_OR_WINTER_TIME','3:30pm (UTC/GMT)');
...
define('FS_FSCOM','https://www.fs.com/uk');
...
define('FS_SHIP_SAME_DAY', 'Dispatched Within 24 Hrs');
...
define('MANAGE_ORDER_SHIPING','Deliver to');
...
define('FS_THEA_CTUAL_SHIPPING_TIME','We are always devoted to offering the fastest delivery with multi-warehouse system. Learn more about our <a href="uk/shipping_delivery.html">shipping policy</a>.');
...
define('FS_WAREHOSE_EU_TIP','Free delivery on orders over £79 ');
...
define('FS_EMAIL_FSCOM','https://www.fs.com/uk');
...
define('FS_EMAIL_URL_1','http://www.fs.com/uk/privacy_policy.html');
/*
 *客户联系客服email to us
 */
...
define('FS_EMAIL_TO_US_URL','https://www.fs.com/uk/service/fs_support.html');
...
define('FS_EMAIL_MY_ACCOUNT_URL','http://www.fs.com/uk/service/fs_support.html');
...
define('FS_MODIFY_EMAIL_MY_CASE_05','If you require immediate attentions, please call us at <a href="tel:+1 (888) 468 7419" style="color:#232323; text-decoration:none;">++1 (888) 468 7419</a> (UK), or <a href="tel:+49 (0) 89 414176412" style="color:#232323; text-decoration:none;">+49 (0) 89 414176412</a> (Germany). You may also live chat to get a quick response.');
...
//*****
define("FS_FOR_FREE_SHIPPING_US",'on orders over $MOENY');
...
if (get_warehouse_by_code($_SESSION['countries_iso_code']) == 'cn') {
    ...
    define('FS_PRE_PRODUCTS_SHIPPING_WD_INFO_04', "We will ship them out after manufacture and thorough test. The shipping speed will depend on the shipping method you choose during checkout. <br> Learn more details about <a href ='".zen_href_link('index')."specials/pre-order-service-71.html' target='_blank'>Pre-Order service</a>.");
}else{
    define('FS_PRE_PRODUCTS_SHIPPING_WD_TITLE', "Free Delivery on Pre-Order Items Over MONEY");
    define('FS_PRE_PRODUCTS_SHIPPING_WD_INFO', "To qualify for free delivery, add at least £299 (ex VAT) Pre-Order items to your Shopping Basket. Any Pre-Order item with 'FREE Delivery' on this page is eligible and contributes to your free delivery order minimum.");
...
define("FS_FOR_FREE_SHIPPING_AU","on orders over AU$99");
...
define("FS_FOR_FREES_SHIPPING_FIVE_DE4"," <span>3pm (UTC/GMT)</span> and choose DHL Express 9:00am at checkout.");
...
define('FS_PRODUCT_INFO_TAX','(Inclusive of 20% <a href="javascript:;" class="vat_info">German VAT</a>)');
...
define('FS_EMAIL_PRODUCT_SHARE10','https://www.fs.com/uk/');
...
define("FS_FESTIVAL7"," to process orders dispatched from Warehouses in United States.");
...
define('ITEM_LOCATION_AU','Melboure, Australia ');
define('FS_COMMON_WAREHOUSE_AU','FS.COM Pty Ltd<br>
...
define('FS_SHOP_CART_ALERT_JS_54','( Shipping and VAT not included )');
...
define("FS_SHOP_CART_TOTAL","Total (Tax included) : ");
...
define("DECLINE_CREDIT","Your card may have been declined for a variety of reasons, common reasons include:");
define("DECLINE_CREDIT1","We are sorry that your card was declined for one of below reasons:");
define("DECLINE_CREDIT2","1.Please be sure that no more than 2 unique Billing Address per card number or per email address appears in 30 days.");
define("DECLINE_CREDIT3","2.Please be sure that the card issuing country is same from country of shipping address in the order.");
define("DECLINE_CREDIT4","You may contact your card bank for reasons at first, and if your card issue can not be resolved shortly, we suggest to change another card or switch into Paypal, Bank Transfer or Check to pay the order.");
define("DECLINE_CREDIT8","3.Please be sure that the billing address in the order is exactly as it appears on your credit card statement.");
define("DECLINE_CREDIT7","Please contact your bank or card issuer to find out the specific reason, since they are the one declining the transaction. Or you may use another credit card or switch the payment method into paypal or Bank Transfer to pay the order.");
define("DECLINE_CREDIT9","Click here to pay with other payment method.");
...
//UK 账户信息
define('FIBER_CHECK_ANZ_UK','Bank Account');
define('FS_SUCCESS_BANK_NAME_UK','Bank Name');
define('FS_SUCCESS_HSBC_UK','Postbank');
define('FS_SUCCESS_AC_NAME_UK','IBAN');
define('FS_SUCCESS_CO_UK','DE59 5901 0066 0902 5446 61');
define('FS_SUCCESS_AC_NO_UK','BIC');
define('FS_SUCCESS_TEL_UK','PBNKDEFF590');
define('FS_SUCCESS_SWIFT_UK','Account Number');
define('FS_SUCCESS_HK_UK','0902544661');
define('FS_SUCCESS_BANK_ADRESS_UK','Bank Code Number');
define('FS_SUCCESS_ROAD_UK','590 100 66');
...
define("FS_US_UP_NOTICE","FS U.S. Warehouses located in Seattle & Delaware respectively, support fast same day domestic shipments within Contiguous U.S., Alaska, Hawaii, APO/FPO military addresses and Puerto Rico, etc, and international shipments to Canada, Mexico.  <a  target='_blank' href=".zen_href_link("shipping_delivery","","SSL").">Read more</a>");
...
define("FS_US_UP_OTHER_NOTICE","FS U.S. Warehouses located in Seattle & Delaware respectively, supports fast same day shipments to United States, Canada, and Mexico.  <a  target='_blank' href=".zen_href_link("shipping_delivery","","SSL").">Read more</a>");
...
define("FS_AU_OTHER_NOTICE","FS AU Warehouse, located in Melbourne, Victoria, supports fast same day domestic shipments within Australia, and international shipments to New Zealand.");
...
define("CULUMS_OFF54","Copyright &copy; 2009-".date('Y',time())." FIBERSTORE LTD All Rights Reserved.");
...
define("FS_CHECKOUT_NEW28","Copyright &copy; 2009-".date('Y',time())." FIBERSTORE LTD All Rights Reserved.");
...
define("FS_BUSINESS_ACCOUNT_10",'+44 (0) 121 716 1755');
define("FS_BUSINESS_ACCOUNT_11",'uk@fs.com');
...
define('FS_LOCAL_COMPANY_NAME','FIBERSTORE Ltd.');
...
define('FS_SALES_INFO_MODAL_ZIP_CODE','Postcode*');
...
define("FS_INQUIRY_LIST_36",'Quote Placed Date:');
...
define('FS_NOTICE_HEADER_COMMON_TIPS',' Delivery times may be longer than usual due to COVID-19 and Brexit effect.');
...
define('FS_PO_FILE_2','380 Centerpoint Blvd, New Castle,<br /> DE 19720d States, Unite');
