...
define('FOOTER', '<tr>
        ...
        <td bgcolor="#E2E2E2" height="160" style="border-bottom:1px solid #C6C6C6; "><div style=" height:140px; border-right:1px solid #C6C6C6; padding:0 5px;"><strong>Información</strong><br />
                <a href="http://www.fs.com/contact_us.html" target="_blank" style=" color:#616265; text-decoration:none;">Contacte con nosotros</a><br />
                <a href="http://www.fs.com/about_us.html" target="_blank" style=" color:#616265; text-decoration:none">Acerca de nosotros</a><br />
                <a href="http://www.fs.com/index.php?main_page=why_us" target="_blank" style=" color:#616265; text-decoration:none">Por qué nosotros</a><br />
                <a href="http://www.fs.com/privacy_policy.html" target="_blank" style=" color:#616265; text-decoration:none">Política de Privacidad</a><br />
                <a href="http://www.fs.com/site_map.html" target="_blank" style=" color:#616265; text-decoration:none">Mapa del Sitio</a><br />
        ...
        <td bgcolor="#E2E2E2" style="border-bottom:1px solid #C6C6C6; "><div style=" height:140px; border-right:1px solid #C6C6C6; padding:0 5px;"><strong>Servicio al Cliente</strong><br />
                <a href="http://www.fs.com/index.php?main_page=get_a_quick_quote" target="_blank" style=" color:#616265; text-decoration:none">Obtener una cotización rápida</a><br />
                <a href="http://www.fs.com/index.php?main_page=oem" target="_blank" style=" color:#616265; text-decoration:none">OEM</a><br />
                <a href="http://www.fs.com/index.php?main_page=payment_methods" target="_blank" style=" color:#616265; text-decoration:none">Formas de Pago</a><br />
                <a href="http://www.fs.com/index.php?main_page=shipping_guide" target="_blank" style=" color:#616265; text-decoration:none">Guía de envío</a><br />
                <a href="http://www.fs.com/index.php?main_page=custom_OEM" target="_blank" style=" color:#616265; text-decoration:none">Solución</a><br />
                <a href="http://www.fs.com/index.php?main_page=estimated_lead_time" target="_blank" style=" color:#616265; text-decoration:none">Tiempo estimado</a></div></td>
        <td bgcolor="#E2E2E2" style="border-bottom:1px solid #C6C6C6; "><div style=" height:140px; border-right:1px solid #C6C6C6; padding:0 5px;"><strong>Mi cuenta</strong><br />
                <a href="http://www.fs.com/login.html" target="_blank" style=" color:#616265; text-decoration:none">Inicie sesión o Regístrese</a><br />
                <a href="http://www.fs.com/index.php?main_page=manage_orders" target="_blank" style=" color:#616265; text-decoration:none">Mis pedidos</a><br />
                <a href="http://www.fs.com/index.php?main_page=manage_wishlists" target="_blank" style=" color:#616265; text-decoration:none">Mis Favoritos</a></div></td>
        <td bgcolor="#E2E2E2" style="border-bottom:1px solid #C6C6C6; "><div style=" height:140px; padding:0 5px;"><strong>Ayuda rápida</strong><br />
                <a href="http://www.fs.com/how_to_buy.html" target="_blank" style=" color:#616265; text-decoration:none">Cómo comprar</a><br />
                <a href="http://www.fs.com/password_forgotten.html" target="_blank" style=" color:#616265; text-decoration:none">Olvidaste tu contraseña?</a><br />
                ...
                <a href="http://www.fs.com/index.php?main_page=faq" target="_blank" style=" color:#616265; text-decoration:none">Preguntas más frecuentes</a></div></td>
        <td bgcolor="#E2E2E2"></td>
    </tr>');
...
define('FS_SHIPPING_COST', 'Delivery Cost');
...
define('F_BODY_HEADER_ITEMS','Item(s)');
...
define('FIBERSTORE_ADD_TO_CART','Add to Basket');
...
// shopping_cart box text in sideboxes/shopping_cart.php
  define('BOX_HEADING_SHOPPING_CART', 'Basket');
...
// payment method is GV/Discount
  ...
  define('TEXT_INVALID_COUPON_PRODUCT', 'This coupon code is not valid for any product currently in your basket.');
...
// cart contents
  define('PRODUCTS_ORDER_QTY_TEXT_IN_CART','Quantity in Basket: ');
  define('PRODUCTS_ORDER_QTY_TEXT','Add to Basket: ');
...
// for all pages except where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCT', 'Successfully added Product to the basket ...');
// only for where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCTS', 'Successfully added selected Product(s) to the basket ...');
...
// product_listing
  ...
  define('PRODUCTS_QUANTITY_IN_CART_LISTING','In basket:');
  ...
  define('ERROR_MAXIMUM_QTY','The quantity added to your basket has been adjusted because of a restriction on maximum you are allowed. See this item: ');
  define('ERROR_CORRECTIONS_HEADING','Please correct the following: <br />');
  define('ERROR_QUANTITY_ADJUSTED', 'The quantity added to your basket has been adjusted. The item you wanted is not available in fractional quantities. The quantity of item: ');
...
// shopping cart errors
  ...
  define('ERROR_PRODUCT_STATUS_SHOPPING_CART','<br />We are sorry but this product has been removed from our inventory at this time.<br />This item has been removed from your shopping basket.');
  ...
  define('WARNING_SHOPPING_CART_COMBINED', 'NOTICE: For your convenience, your current shopping basket has been combined with your shopping basket from your last visit. Please review your shopping basket before checking out.');
...
// Shipping Estimator
  ...
  define('CART_ITEMS','Items in basket: ');
  ...
  define('EMPTY_CART_TEXT_NO_QUOTE', 'Whoops! Your session has expired ... Please update your shopping basket for Shipping Quote ...');
...
// END OF EXTERNAL LANGUAGE LINKS
  ...
  define('FIBERSTORE_WISHLIST_ADD_TO_CART','Add To Basket');
...
define('FS_BUSINESS_DAYS','Working Days');
define('FS_BUSINESS_DAY','Working Day');
...
define('FS_ADDRESS_STREET_FORMAT_TIP','Address line 1 must be between 4 and 35 characters long.');
...
define('FS_THEA_CTUAL_SHIPPING_TIME','We are always devoted to offering the fastest delivery with multi-warehouse system. Learn more about our <a href="'.reset_url('shipping_delivery.html').'">shipping policy</a>.');
...
define('FS_CHECK_OUT_REVIEW','Review Items and Delivery');
...
define('FS_CHECK_OUT_INCLUDEING','(VAT included)');
define('FS_CHECK_OUT_EXCLUDING','(VAT excluded)');
...
define('FS_CHECK_OUT_EXCLUDING_RU_NATURE','(VAT excluded)');
...
define('FS_CHECK_OUT_BUSINESS','Business Type');
define('FS_CHECK_OUT_INDIVIDUAL','Individual Type');
//checkout快递类型
...
define('FS_WAREHOSE_CA_TIP','Free shipping on orders over $79 dispatched from U.S. Warehouse');
...
define('FS_HEADER_FREE_SHIPPING_US_TIP','Free Shipping on Orders over USD $79');
define('FS_FOOTER_FREE_SHIPPING_US_TIP','Free Shipping');
define('FS_HEADER_FREE_SHIPPING_DE_TIP','Free Delivery on Orders of Eligible Items over $MONEY');
define('FS_FOOTER_FREE_SHIPPING_DE_TIP','Free Delivery');
define('FS_HEADER_FREE_SHIPPING_AU_TIP','Free Delivery on Orders of Eligible Items over A$99 dispatched from AU warehouse');
...
define('FS_M_FREE_SHIPPING_DE_TIP','Free Delivery on Orders over $MONEY');
...
define('FS_PRODUCT_INSTALLATION_TEXT','Fit in <a href="'.zen_href_link('product_info','products_id=30408','SSL').'" style="color: #0070BC;">FMU-1UFMX-N</a> chassis that can be mounted on a rack');
 ...
 *客户保留购物车产品，邮件发给自己
 */
define('FS_EMAIL_CART','Your basket list is waiting for you.');
...
define('FS_EMAIL_SHARE',"'s Share With A Friend service. As a result of receiving this message, ");
define('FS_EMAIL_WERDEN','you will not receive any unsolicited message from');
...
define('FS_EMAIL_CARTS_1','has shared a basket list with you!');
...
define('FS_EMAIL_MY_ACCOUNT_URL','http://www.fs.com/live_chat_service.html');
...
define('FS_EMAIL_MY_PO_UP_URL','https://www.fs.com/manage_orders.html');
define('FS_EMAIL_MY_PO_UP_URLS','http://www.fs.com/contact_us.html');
/*
 * 线上PO订单确认邮件
 */
...
define('FIBER_CHECK_USE','Use my own delivery account');
define('FIBER_CHECK_FREE','Free');
define('FIBER_CHECK_FREE_SHIPPING','Free Delivery');
...
define('FS_COMMON_REORDER_CUSTOM','Blow is customized product(s) , please re-choose the characters in product introduction.');
...
define("FS_WAREHOUSE_AREA_3","ship from DE Warehouse");
...
define("FS_WAREHOUSE_AREA_7","separate packages. ");
...
define("FS_WAREHOUSE_AREA_16","! Below is summary of your latest open order. Just one last step to finish payment, all will be yours.");
...
define("REGITS_FROM_GUEST_NOTE",'Note: Your phone number is only used to contact you on delivery, as well as your email address to update the order status.<br>You can visvit <a href='.HTTPS_SERVER.reset_url('policies/privacy_policy.html').'>Privacy Policy</a> for more information.');
...
define('FS_MODIFY_EMAIL_MY_CASE_03','Thank you for contacting <a href="'.HTTPS_SERVER.'/" target="_blank" style="color:#232323; text-decoration:none;">FS.COM</a>, this is a confirmation email to let you know that your request for support has been received under case');
define('FS_MODIFY_EMAIL_MY_CASE_04','Our <a href="'.HTTPS_SERVER.'/" target="_blank" style="color:#232323; text-decoration:none;">FS.COM</a> sales team will review your case and get back to you within 12 hours.');
...
define('FS_MODIFY_EMAIL_MY_CASE_07','<a href="'.HTTPS_SERVER.'/" target="_blank" style="color:#232323; text-decoration:none;">FS.COM</a> Customer Service Team ');
...
define('FS_EMAIL_REQUEST_STOCK_06','If you require immediate attentions, please call us at <a href="tel:+1 (877) 205 5306" style="color:#232323; text-decoration:none;">+1 (877) 205 5306</a> (US), or <a href="tel:+49 (0) 89 414176412" style="color:#232323; text-decoration:none;">+49 (0) 89 414176412</a> (Germany). You may also live chat to get a quick response.');
define('FS_EMAIL_REQUEST_STOCK_07','Sincerely,');
define('FS_EMAIL_REQUEST_STOCK_08','<a href="'.HTTPS_SERVER.'/" target="_blank" style="color:#232323; text-decoration:none;">FS.COM</a> Customer Service Team ');
...
define("FS_JS_TIT_CHECK8","pick phone");
...
if (!in_array(strtoupper($_SESSION['countries_iso_code']), array('BL', 'MF'))) {
    define("FS_FOR_FREE_SHIPPING_DE_MONEY",' on orders over $MONEY (excl. VAT)');
} else {
...
if (get_warehouse_by_code($_SESSION['countries_iso_code']) == 'cn') {
    ...
    define('FS_PRE_PRODUCTS_SHIPPING_WD_INFO_04', "We will ship them out after manufacture and thorough test. The shipping speed will depend on the shipping method you choose during checkout. <br><br> Learn more details about <a href ='shipping_delivery.html' target='_blank'>delivery policy</a>.");
}else {
    define('FS_PRE_PRODUCTS_SHIPPING_WD_TITLE', "Free Delivery on Pre-Order Items Over MONEY");
    define('FS_PRE_PRODUCTS_SHIPPING_WD_INFO', "To qualify for free delivery, add at least MONEY Pre-Order items to your Shopping basket. Any Pre-Order item with 'FREE Delivery' on this page is eligible and contributes to your free delivery order minimum.");
    define('FS_PRE_PRODUCTS_SHIPPING_WD_INFO_03', "The processing time for Pre-Order items will be around 15 business days. We will ship them out after manufacture and thorough test. The delivery speed will depend on the delivery option you choose during checkout.");
...
//修改2018.5.8
define("FS_FOR_FREES_SHIPPING_FIVE_DE1"," <span>4pm (UTC/GMT +1)</span> and choose UPS Express Plus Next Day 9:00am at checkout.");
...
define("FS_FOR_FREE_SHIPPING_GB4","in UK");
...
define("FS_SHIPPING_POLICY_DE","The delivery date applies to the inventory items purchased by ".(SUMMER_TIME ? '4:30pm (UTC/GMT+2)' : '4:30pm (UTC/GMT+1)')." on business days. After that, your order will ship on the next business day. If your requested quantity exceeds the inventory, it will be dispatched in another shipment at no extra cost. For more details, please refer to the checkout page.");
...
define('FS_REQUEST_DEADLINE','Request was closed as scheduled. A updated version will be available in November, please stay tuned.');
//英国专用提示
...
define('FS_CHECKOUT_USE_ADDRESS',"Use my Delivery address as my billing address");
define('FIBERSTORE_YOUR_RECENT_HISTOR','Recently Viewed');
define('FS_PRODUCT_INFO_PREIS','Price: ');
define("FS_NET_PRODUCT16","Check back periodically to this New Products page to see our latest offering");
define("FS_NET_PRODUCT19","Sort By");
define("FS_NET_PRODUCT20","Featured");
define("FS_NET_PRODUCT17","Price: Low to High");
define("FS_NET_PRODUCT18","Price: High to Low");

define('FS_PRODUCT_INFO_TAX','(Inclusive of 19% German <a href="javascript:;" class="vat_info">VAT</a>)');
define("PRODCUT_CATALOGS_01","Products Catalogs");
define("PRODCUT_CATALOGS_03","Solutions");
define("PRODCUT_CATALOGS_04","Product Videos");

define("CHECKOUT_ONESELF_PICH",'I\'ll pick it up in person');
define("FS_LOCAL_URL_MESSAGE","Free Germany delivery on orders over 79,00 € dispatched from EU (Germany) Warehouse");
define("FIBER_CHECK_BANK_NUM","Account Number");
define("FIBER_CHECK_BANK_DRESS","Beneficiary Bank Address");
define("FS_ADDERSS_LIMIT","Sorry, this item can't be sent to your selected address. You may switch to the region close to you to continue shopping");
define("FS_CHECKOUT_ADDRESS_ADD","Update Address");

define("FS_LOGIN_REGIST_PFICHTFELDER","* Required fields");


//公司类型
define('FS_CHECK_OUT_GO','Government/Organization');
define('FS_PAY_RECHNUNG',"Payment by Invoice");
...
define('FS_ADDRESS_INVOICE','INVOICE');


define('FS_ADDRESS_INVOICE','INVOICE');
define("FS_SUCCESS_RE","Payment by Invoice");
//节假日 提醒
...
define("CHECKOUT_TAXE_CN_FRONT1","All orders shipped from our CN Warehouse to China Mainland, HK, Macao and Taiwan can enjoy FREE Shipping (to Mainland, default SF Express and Fedex IE by default to HK, Macao and Taiwan).");
...
//guest
define("FS_GUEST_HAVA",'The email address exists in our system, Please log in directly.');
define("FS_GUEST_LOGIN",'login');
...
define('FS_SHOP_CART_ALERT_JS_53','Basket Summary');
define('FS_SHOP_CART_ALERT_JS_54','( Delivery cost not included )');
...
define('FS_SHOP_CART_ALERT_JS_58','Saved Basket');
define('FS_SHOP_CART_ALERT_JS_59','Your order qualifies for FREE Delivery ');
define('FS_SHOP_CART_ALERT_JS_60','Deliver to');
define('FS_SHOP_CART_ALERT_JS_61','All orders of US$79 or more of eligible items across any product category qualify for FREE Delivery.');
define('FS_SHOP_CART_ALERT_JS_62','To qualify for FREE Delivery, add ');
...
define('FS_SHOP_CART_ALERT_JS_67','All orders of 79 € or more of eligible items across any product category qualify for FREE Delivery.');
define('FS_SHOP_CART_ALERT_JS_68','All orders of £79 or more of eligible items across any product category qualify for FREE Delivery.');
...
define('FS_SHOP_CART_ALERT_JS_72','Save Basket');
define('FS_SHOP_CART_ALERT_JS_72_1','Save Basket');
define('FS_SHOP_CART_ALERT_JS_73','Email your basket');
define('FS_SHOP_CART_ALERT_JS_74','Print');
define('FS_SHOP_CART_ALERT_JS_75','Share again');
define("FS_AJAX_DELETE1","was successfully removed from your basket.");
define("FS_AJAX_DELETE2","Undo");
define("FS_SHOP_CART_VAT_COST","VAT 19% of the products :");
define("FS_SHOP_CART_VAT_COST_FR","VAT 20% of the products : ");
define("FS_SHOP_CART_TOTAL","Total (VAT included) :");
...
define('FS_CHECK_OUT_TAX_DE','VAT');
...
define("FS_CHECKOUT_NEW25","By clicking 'Proceed to Secure Payment' , you agree to our");
define("FS_CHECKOUT_NEW26","Terms and Conditions");
define("FS_CHECKOUT_NEW27","Submit Order");
define('FS_CHECKOUT_NEW27_01','and');
define('FS_CHECKOUT_NEW27_02','Right of Withdrawl');
...
define("FS_CHECKOUT_NEW42"," and ");
define("FS_CHECKOUT_NEW43","Right of Withdrawl");
...
define("FS_CHECKOUT_EXPIRED","Your login session has expired?");
define("FS_CHECKOUT_EXPIRED_CONFIRM","confirm");
define("CHECK_SEARCH","Search");
define("FS_CHECKOUT_ERROR29","Please edit your address(enter the valid postal code).");

define("FS_CHECKOUT_ERROR35","Please edit your address(select the valid country).");
//add by helun
...
define("CREDIT_CARD_NUMBER","Card Number");
define("CREDIT_CARD_DATE","Expiry date");
define("CREDIT_CARD_CVV","CVV");
define("CREDIT_CARD_PAY","Continue");
/******meta标签语言包*****/
define("FS_META_PRO_01","Worldwide shipping for ");
define("FS_META_PRO_02"," enjoying great price and top notch service.");

define('FS_CHECKOUT_TIP_01','FS.COM provides a variety of payment methods for you. For more details, please check ');
define('FS_CHECKOUT_TIP_02','Payment Methods');
...
//加購彈窗
define("FS_NEW_POPUP_01","You just added");
define("FS_CART_QTY","Qty:");
define("FS_CONTINUE_SHOPPING","Continue Shopping");
define("FS_NEW_POPUP_04","View Basket");
define('FS_CUSTOMERS_ALSO','Customers also bought these products.');
define('FS_SHOPPING_CART_NEW_SHARE_CART', 'Share Basket');
define('FS_SHOPPING_CART_NEW_PRINT_CART', 'Print Basket');
...
define("FS_LOGIN_THIRD1","DEAR");
define("FS_LOGIN_THIRD2","user");
define("FS_LOGIN_THIRD3",", welcome!");

define("FS_LOGIN_THIRD4", "We notice that there is a registered FS.COM account with the same email address. We'll link your FS.COM account to better maintain your personal data and preferences. If you are not aware of this FS.COM account, please contact us.");
define("FS_LOGIN_THIRD5"," Redirect to your FS.COM account in ");
 ...
 * 新版详情页
 */
define('FS_PLEASE_SELECT','Please select...');
define('FS_JUST_ADD','You just added ');
define('FS_POPUP_ITEM',' item');
define('FS_COUNTINUE_SHOPPING','Continue Shopping');
define('FS_PRODUCT_SHIPPING','Shipping');
define('FS_PRODUCT_RETURNS','Returns');
define('FS_PRODUCT_LIVE_CHAT','Live Chat');
define('FS_PRODUCT_EXPERT','Ask Our Expert: ');
define('FS_PRODUCT_QUESTIONS','Questions');
define('FS_PRODUCT_QUESTION','Question');
define('FS_REVIEWS_PLACE','Write down your comments...');
define('FS_REVIEWS_BY','By');
define('FS_REPLY_REVIEWS','Showing 1 comment');
define('FS_PRODUCT_CART_POPUP','Customers also bought these products');
...
define("FS_TIME_ZONE_ADDRESS_US_ES","<span>Warehouse Location:</span> 380 Centerpoint Blvd, New Castle, DE 19720, United States | +1 (425) 326 8461 ");
define("FS_ITEMS_CK","items");

define("FS_TIME_ZONE_RULE_AU","(AEST)");
define("FS_JS_TIT_CHECK_AU","9:30am - 5pm ");

//checkout语言包
define('FS_UNITED','United States');
define('FS_AUSTRALIA','Australia');
define('FS_GERMANY','Germany');
...
define("FS_PRODUCT_INFO_PIECE","Order By Piece");
...
//详情页政策弹窗
define('FS_PRODUCTS_INFO_VAT_05','About VAT Tax');
define('FS_PRODUCTS_INFO_VAT_01','All orders to destinations within  EU members are dispatched from our primary warehouse in Munich, Germany. In accordance with the laws governing members of the European Union and General Tax Law of Germany, FS.COM GmbH is obliged to charge a regular 19% VAT on all items delivered to  EU members (For France, VAT rate is 20%).');
define('FS_PRODUCTS_INFO_VAT_02','VAT Exempt');
define('FS_PRODUCTS_INFO_VAT_03','VAT will be exempted for orders delivered to EU members (except Germany), if buyers are EU businesses and valid European Union Value Added Tax Identification Numbers are offered at checkout page.');
define('FS_PRODUCTS_INFO_VAT_04','After you complete the delivery address at checkout page, you will be able to see an exact total amount inclusive of applicable VAT in order summary. <a href="en/shipping_delivery.html
">Learn more</a>');
...
define('FS_PRICE_EXCL_VAT','  (Excl. VAT)');
define('FS_PRICE_INCL_VAT',' (Incl. VAT)');
define('FS_DE_TAX_TEXT', 'Depending on your delivery address, VAT may vary at Checkout.');
...
define("FS_SHIP_ZIP_CODE"," postal code");
...
define("FS_PRODUCTS_POST_CODE_EMPTY_INVALID","Please enter a valid postal code");
...
define("FS_SHIP_LIST_POST","postal code");
...
define("FS_PRODUCTS_POST_CODE_EMPTY_ERROR","Your Postal Code is required");
...
define("SEND_MAIL_8","FS.COM Pty Ltd, ABN 71 620 545 502,57-59 Edison Rd, Dandenong South, VIC 3175, Australia");
define("SEND_MAIL_9","Same Day Shipping on Stock Items");
define("SEND_MAIL_10","FS.COM Limited Room 2702, 27 Floor Yisibo Software Building, Haitian Second Road, Yuehai Street Nanshan District, Shenzhen, 518054, China");
...
define("FS_INQUIRY_CANCEL_QUOTE_TIP2",'However, if you really mean that, pls kindly provide us a reason(s) for canceling: ');
...
define('FS_ADDED_TO_CART','Added to Basket');
...
define('FS_PAGE_NOT_FOUND','Page Not Found');
define('FS_CUSTOMILIZED_ADD_TO_CART','Add to Basket');
...
define('FS_DELETE_CART_TITLE','Delete Saved basket');
define('FS_SYMBOL',',');
...
define("FS_SHOP_CART_ALERT_JS_77","View Basket");
define('FS_PLACEHOLDER','500 characters maximum allowed.');
...
//加购弹窗
define('FS_ADD_CART_PROCHUSE','Basket Subtotal ');
...
define('FS_AGAINST_YOUR','Your Payment Time field is required(ex: 2014-6-12)');
...
define("FS_AGAINST_CART",'My Account');
define('FS_ALLOWED_FILE_TYPES','Allowed file types: ');
define('FS_SUCCESS_CART','Basket');
...
define('FS_ORDER_EMAIL_04',' are below. We\'ll send you an email as soon as an update comes from your order.');
...
define('FS_SEND_EMAIL_32',"FS - We received your return request");
...
define('FS_SEND_EMAIL_36',"FS - We received your remaintaince request");
define('FS_SEND_EMAIL_37',"We've received your remaintaince request and will email you with more information within one business day.");
...
define('FS_SEND_EMAIL_43'," and will email you with more information about your Remaintaince parts within one business day.");
define('FS_SEND_EMAIL_44',"Refund parts");
define('FS_SEND_EMAIL_45',"Replacement parts");
define('FS_SEND_EMAIL_46',"Remaintaince parts");
...
//详情页定制产品加购弹窗
define('FS_CUSTOMIZED_INFORMATION','Customised Information');
define('FS_CUSTOMIZED','Customised');
...
define("FS_INQUIRY_INFO_48","Quote List");
...
define('FS_SALES_INFO_MODAL_ZIP_CODE_EU','Postcode*');
...
define('FILENAME_HOME_CART','Basket');

//购物车登陆且为空的状态 添加save cart入口
define('FS_SAVE_CART_ENTRANCE','Continue shopping on FS or view your <a href="'.zen_href_link('saved_items','type=saved_carts','SSL').'">Saved Basket</a>.');
...
define('CASE_STUDIES_12','Data Centre Cabling');
...
define("FS_SHIPPING_SG_GRAB_TIPS","This service is available for orders of single shipment dispatched from SG warehouse,  and paid before 3:00pm on working days.");
...
define('FS_ORDERS_OVERTIMES_06','Note: Remarking the FS order number when you transfer will get your order processed timely. Usually funds will be received in 1-3 business days.');
...
define('FS_FESTIVAL16','Public Holiday in Singapore on');
...
define('FS_PRINT_SHIPPING_COST','Delivery Cost:');
define('FS_PRINT_SHIPPING_TAX','VAT:');
...
define('FS_CHECKOUT_POPUP_TIPS','Are you sure you want to return to your Shopping Basket?');
...
define('FS_CHECKOUT_POPUP_BUTTON2','Return to Basket');
...
// MUX流程轴节点
define('FS_ORDER_CUSTOMIZED','Customised');
...
define('FS_BY_CLICKING','By clicking the button above you agree to our');
...
define('CART_SHIPPING_METHOD_CHECKOUT_PRE','Delivery:');
define('CART_SHIPPING_METHOD_CHECKOUT_TEXT','Calculated at checkout');
define('FS_COMMON_GSP_1','ship from and sold by FS Asia');
...
define('FS_DETAIL_CUSTOM_1', 'Customised');
...
define('FS_ALL_SAVED_CARTS','All Saved Baskets');
define('FS_ADD_ALL_TO_CARTS','Add All to Basket');
define('FS_GO','GO');
define('FS_SHOW_CART','Show');
define('FS_SEARCH','search');
define('FS_CART_NAME','Basket Name');
define('FS_SEARCH_SAVED_CARTS','Search Saved Baskets');
...
define('FS_VIEW_SHIPPING_CART','View Shopping Basket');
define('FS_SAVE_CART_CONDITIONS','If you can\'t locate your Saved Basket, try selecting different filter conditions.');
define('FS_NO_SAVED_CART_FOUND','No Saved Basket Found.');
define('FS_CRET_REFERENCE','Basket Reference');
define('FS_CART_DELETE','Delete');
define('FS_CART_NEW_ITEMS','New item(s) have been added to your');
define('FS_CART_SUCCESSFULLY_UPDATED','Your basket has been successfully updated');
define('FS_CART_SAVED_CART_NAME','Saved Basket Name');
define('FS_CART_NEW_CART_CREATE','New basket has been created.');
define('FS_CART_HAS_BEEN_ADD','has been added to your Saved Baskets.');
define('FS_CART_NAME_ALREADY_EXISTED','This name has already existed. Please use a different name.');
define('FS_ADD_TO_SAVED_CART','Add to Saved Basket');
define('FS_SAVE_CART_SELECT','Select Saved Basket');
define('FS_ADD_THE_ITEMS','Or, add the item(s) into an existing Saved Basket.');
define('FS_NAME_YOUR_SAVED_CART','Name Your Saved Basket');
define('FS_ADD_TO_CART','Add to Basket ');
define('FS_EMIAL_YOUR_CART','Email Your Basket');
define('FS_PRINT_THIS_PAGE','Print this page');
define('FS_SAVED_CART_DETAILS','Saved Basket Details');
define('FS_BELOW_IS_THE_CART','Below is the basket details you have saved.');
define('FS_CART_CONTACT_CUSTOMER_SERVICE','Contact Customer Service');
define('FS_UPDATED_SUCCESSFULLY','Your basket has been updated successfully.');
define('FS_NEW_ITEM_CART','New item(s) has been added to your Saved Basket ');
define('FS_CART_ALL_ITEMS','All item(s) in this basket is no longer available for purchase, please contact your account manager for availability.');
define('FS_CART_SOME_CUSTOMIZED','Some customized item(s) in this basket  have been changed, please go to the product details page to select attributes.');
define('FS_CART_ALL_CUSTOMEIZED_ITEMS','All items in this basket have been changed,  please go to the product details page to select attributes.');
...
define('FS_CART_SHOPPING_CART_DIRECTLY','The item(s) in this basket is no longer available for purchase online, please contact your account manager for availability. At the meantime, the availale items have been moved into shopping basket directly.');
...
define('FS_CART_CUSTOMIZED_SHOPPING_CART','The customized item(s)  in this basket have been changed, please go to the product details page to select attributes. At the meantime, the availale items have been moved into shopping basket directly.');
define('FS_SAVE_CSRT_LIMIT_TIP_CART','Please enter the basket name maximum 150 words.');
define('FS_FROM','From');
define('FS_TO_EMAIL','To');
define('FS_SELECT_SAVE_CART','Please select save basket.');


define('FS_NOTICE_FREE_SHIPPING','Free shipping on orders over $MONEY');
define('FS_NOTICE_FREE_DELIVERY','Free delivery on orders over $MONEY (Excl. VAT)');
...
//头部购物车loading板块提示语
define('FS_TOP_CART_LOAD_TITLE', 'Basket Loading');
...
define('FS_CHECKOUT_SPEC_PRODUCTS_DOUBT','Can\'t find a delivery option?');
...
define('FS_REVIEW_09','Allow files of type of JPG, JPEG, PNG.  Maximum file size: 5MB');
...
define('FS_MY_SHOPPING_CART','My Shopping Basket');
...
define('FS_REVIEWS_TAG_01', 'Customer Gallery');
...
define('FS_ADVANCED_SEARCH_RESULT_TIP_2', 'Did you search for <a target="_blank" href="###HREF_LINK###">###RECOMMEND_WORD###</a>');
...
define('SEARCH_OFFLINE_PRODUCT_TIP', '"KEYWORD" is no longer available online, but still supported by FS. For more details, please refer to the <a  style="color: #0070BC;text-decoration: none" href="'.zen_href_link('offline_products_eos').'" target="_blank" style="color: #0070BC;text-decoration: none">End of Sale Policy</a>.');
//信用卡语言包
