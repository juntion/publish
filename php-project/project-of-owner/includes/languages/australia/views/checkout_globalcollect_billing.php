...
define("GLOBAL_TEXT2","The payment was declined. Please use another credit card or change the payment method into PayPal or Wire Transfer on an open order.");
...
define("GLOABL_TEXT_DECLINED_4","You may contact your card bank for reasons at first, and if your card issue can not be resolved shortly, we suggest to change another card or switch into Paypal, Wire Transfer or Check to pay the order.");
...
define("GLOABL_TEXT_DECLINED_7","Please contact your bank or card issuer to find out the specific reason, since they are the one declining the transaction. Or you may use another credit card or switch the payment method into paypal or wire transfer to pay the order.");
