...
define('FS_PRINT_AVE_QUOTE','57-59 Edison Rd, Dandenong South <br >');
define('FS_PRINT_US','VIC 3175, Australia (ABN 71 620 545 502)');
...
define('FS_PRINT_WE','We provide 24/7 customer support, including product selection, sizing, installation, product customization, and technical solution. ');
...
define('FS_PRINT_INSTRUCTIONS_01','1. Delivery cost is not included in the above subtotal.');
