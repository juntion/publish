...
define('FIBERSTORE_PAYPAL_RECEIVED','Orden recibida, esperando la confirmación de pago');
define('FIBERSTORE_PAYPAL_NO','Número de orden.:');
define('FIBERSTORE_CHECKOUT_ON','pedido el');

define('FIBERSTORE_CHECKOUT_PAYPAL','Orden recibida, esperando la confirmación de pago');
define('FIBERSTORE_CHECKOUT_PAYPAL_FOOTER','Para cualquier ayuda, por favor envíenos un correo electrónico a sales@fiberstore.com o llámenos al +86-75583003611 o en vivo, haga clic en el chat para chatear en línea o dejar un mensaje, nos ocuparemos de ella en un día hábil.');
...
define('FIBERSTORE_CHECKOUT_ONCE','Una vez que confirmemos su pago y termine de procesar su pedido, sus artículos serán embalados y enviados inmediatamente a su destino.');
define('FIBERSTORE_USE_ORDER','Usted puede utilizar su número para verificar esta Orden es el estado en cualquier momento en Mis Pedidos. Para más detalles sobre los tiempos de procesamiento y entrega, por favor póngase en contacto con nosotros.');
define('FIBERSTORE_CHECKOUT_FAQ','Para cualquier otra pregunta, visite nuestro preguntas frecuentes.');
define('FIBERSTORE_HOW_CONTACT','?Cómo puedo contactar con usted?');
define('FIBERSTORE_CHECKOUT_HELP','Para cualquier ayuda, por favor envíenos un correo electrónico a');
define('FIBERSTORE_CHECKOUT_CALL','o nos dan una llamada en +86-75583003611 o en vivo, haga clic en el chat para chatear en línea o dejar un mensaje, nos ocuparemos de ella dentro de 24 horas.');
  

define('FIBERSTORE_CHECKOUT_THANK_FOR_SHOPPING','Thank you for shopping at www.FiberStore.com. Your order');
define('FIBERSTORE_CHECKOUT_PLACED_ON','placed on');
define('FIBERSTORE_CHECKOUT_RECEIVED_SEND','has been received. Yet it is still unpaid. If you still need the items, you can send the payment to our company\'s paypal account directly:');
define('FIBERSTORE_CHECKOUT_PLEASE_CONTACT_US','If there is any problems or questions with the paypal payment, please feel free to contact us at');
define('FIBERSTORE_CHECKOUT_PAYPAL_MAIL','paypal@fs.com.');
define('FIBERSTORE_CHECKOUT_SERVICE_MAIL','service.us@fs.com');
define('FIBERSTORE_DEAR','dear');;
  /*eof*/
