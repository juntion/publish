...
define('TEXT_INFORMATION', '<p>If you try to place an order, please login and your shopping basket will be restored. You can then go back to the box and complete your final purchases.</p><p>If you have completed an order and wish to review' . (DOWNLOAD_ENABLED == 'true' ? ', or has a discharge and want it back' : '') . ',please refer to your <a href="' . zen_href_link(FILENAME_ACCOUNT, '', 'SSL') . '">My Account</a> page to view your order.</p>');
