...
5. Insert the Web Tools User ID in the Zen Basket USPS shipping module.<br />
...
7. They will send another confirmation email. Set the Zen Basket module into Production mode (instead of Test mode) to finish activation.': ''));
...
define('MODULE_SHIPPING_USPS_TEXT_TEST_MODE_NOTICE', '<br /><span class="alert">Your account is in TEST MODE. Do not expect to see usable rate quotes until your USPS account is moved to the production server (1-800-344-7779) and you have set the module to production mode in Zen Basket admin.</span>');
