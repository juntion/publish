...
define("FS_FAST_DELIVERY","30-Day Return");
...
define('FS_FOOTER_FEEDBACK','Give Feedback');
// 2018.7.5/7.14 小语种/英文新版首页上线 fairy 新增
define("FS_FOOTER_COPYRIGHT","Copyright 2009-".date('Y',time())." ".FS_LOCAL_COMPANY_NAME." All Rights Reserved.");
define("FS_FOOTER_COPYRIGHT_M","Copyright © 2009-YEAR <span>FS.COM</span> All Rights Reserved.");
