...
<div class="oem_customs_con">
  ...
  <div class="categories_select">
    <ul>
      <li class="select01"><a href="c/data-center-solutions-1308" target="_blank"><span><?php echo FS_OEM_CLOUD;?></span></a></li>
      <li class="select02"><a href="support/custom-wdm-otn-solutions-for-long-haul-applications-100" target="_blank"><span><?php echo FS_OEM_TRANSMISSON;?></span></a></li>
      <li class="select03"><a href="/Enterprise-Networks.html" target="_blank"><span><?php echo FS_OEM_ACCESS;?></span></a></li>
    </ul>
  </div>
  <div class="ccc"></div>
