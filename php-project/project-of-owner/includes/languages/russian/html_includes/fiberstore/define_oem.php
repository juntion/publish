...
<div class="oem_customs_con">
  ...
  <div class="categories_select">
    <ul>
      ...
      <li class="select03"><a href="<?php echo $code;?>/support/fbt-plc-fiber-splitter-high-bandwidth-data-transmission-in-ftth-solution-118" target="_blank"><span><?php echo FS_OEM_TRANSMISSON;?></span></a></li>
    </ul>
  </div>
  <div class="ccc"></div>
