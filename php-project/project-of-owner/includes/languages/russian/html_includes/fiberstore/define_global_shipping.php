...
<script src="<?php echo $code; ?>/includes/templates/fiberstore/jscript/echarts.common.min.js" type="text/javascript"></script>
    <div class="page_nav">
      <div class="page_nav_con">
        <div class="big_title"><a><?php echo FS_GLOBAL_1;?></a>
        </div>
        <div class="short_title"><a href="<?php echo zen_href_link(FILENAME_PAYMENT_METHODS);?>"><?php echo FS_GLOBAL_2;?></a><a href="<?php echo zen_href_link('net_30');?>"><?php echo FS_GLOBAL_3;?></a><a href="<?php echo zen_href_link(FILENAME_GLOBAL_SHIPPING);?>" class="title_selected"><?php echo FS_GLOBAL_4;?></a><a href="<?php echo zen_href_link(FILENAME_ESTIMATED_TIME);?>"><?php echo FS_GLOBAL_5;?></a></div>
      </div>
    </div>
    ...
    <div class="payment_con">
      ...
      <div align="center">         		     
	      ...
	      <div class="Pie_shape">
          <dl><dt><span class="bule"></span></dt><dd><?php echo FS_GLOBAL_ORDER;?></dd></dl>
          <dl><dt><span class="green"></span></dt><dd><?php echo FS_GLOBAL_WORK_3;?></dd></dl>
          <dl><dt><span class="orange"></span></dt><dd><?php echo FS_GLOBAL_WORK_4;?></dd></dl>
          <dl><dt><span class="purple"></span></dt><dd><?php echo FS_GLOBAL_WORK_7;?></dd></dl>
          <dl><dt><span class="red"></span></dt><dd><?php echo FS_GLOBAL_WORK_1;?></dd></dl>
	      </div> 
    </div> 
 ...
 <script>
		...
		var option = {
			...
			series: [
				...
				{
					name: '<?php echo FS_GLOBAL_EXP;?>',
					type: 'pie',
					radius: ['40%', '55%'],

					data: [{
							value: 292,
							name: '<?php echo FS_GLOBAL_WORK_2;?>',
							itemStyle: {
								normal: {
									color: '#3ea8f5'
								}
						...
						{
							value: 40,
							name: '<?php echo FS_GLOBAL_WORK_3;?>',
							itemStyle: {
								normal: {
									color: '#04b622'
								}
						...
						{
							value: 14,
							name: '<?php echo FS_GLOBAL_WORK_4;?>',
							itemStyle: {
								normal: {
									color: '#f68e35'
								}
						...
						{
							value: 10,
							name: '<?php echo FS_GLOBAL_WORK_7;?>',
							itemStyle: {
								normal: {
									color: '#7f78e8'
								}
						...
						{
							value: 4,
							name: '<?php echo FS_GLOBAL_WORK_1;?>',
							itemStyle: {
								normal: {
									color: '#fb4553'
								}
