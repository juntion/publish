...
$(function(){
    ...
    <div class="page_nav">
      <div class="page_nav_con">
        ...
        <div class="short_title"><a href="<?php echo zen_href_link('fs_single_pages','name=about_us','SSL');?>"><?php echo FS_ABOUT_US;?></a><a class="title_selected" href="<?php echo zen_href_link(FILENAME_WHY_US);?>"><?php echo FS_FOOTER_WHY_US;?></a><a href="/news/"><?php echo LATEST_NEWS;?></a><a href="<?php echo zen_href_link(FILENAME_CONTACT_US);?>"><?php echo FS_FOOTER_CONTACT_US;?></a></div>
      </div>
    </div>
