...
define('BUTTON_LOG_OFF_ALT', 'Выход');
define('BUTTON_ADD_TO_CART_ALT', 'В корзину');
...
define('BUTTON_BUY_NOW_ALT', 'Купить Сейчас');
define('BUTTON_CANCEL_ALT', 'Отмена');
define('BUTTON_CHANGE_ADDRESS_ALT', 'Сменить Адрес');
define('BUTTON_CHECKOUT_ALT', 'Оформить заказ');
define('BUTTON_CONFIRM_SEND_ALT', 'Отправить Подарочный Сертификат');
define('BUTTON_CONFIRM_ORDER_ALT', 'Подтвердите Заказ');
...
define('BUTTON_DOWNLOAD_ALT', 'Скачать Сейчас');
define('BUTTON_EDIT_SMALL_ALT', 'Редактировать');
define('BUTTON_IN_CART_ALT', 'Добавить в корзину');
define('BUTTON_LOGIN_ALT', 'Войти');
define('BUTTON_NEXT_ALT', 'Далее');
define('BUTTON_PREVIOUS_ALT', 'Предыдущие');
define('BUTTON_REDEEM_ALT', 'Использовать');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Вернуться к Катологу товаров');
define('BUTTON_REVIEWS_ALT', 'Перейти на страницу Отзывов');
define('BUTTON_SEARCH_ALT', 'Поиск');
define('BUTTON_SEND_ALT', 'Отправить Сейчас');
define('BUTTON_SEND_ANOTHER_ALT', 'Отправить ещё Подарочный сертификат');
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Отправить Подарочный Сертификат');
define('BUTTON_SHIPPING_ESTIMATOR_ALT', 'Сметчик Доставки');
define('BUTTON_SOLD_OUT_ALT', 'Проданы');
define('BUTTON_SOLD_OUT_SMALL_ALT', 'Проданы');
define('BUTTON_SUBMIT_ALT', 'Представить информацию');
define('BUTTON_TELL_A_FRIEND_ALT', 'Поделиться с другами');
define('BUTTON_TELLAFRIEND_ALT', 'Поделиться с другами');
define('BUTTON_UNSUBSCRIBE', 'Отписаться');
define('BUTTON_UPDATE_ALT', 'Обновить');
define('BUTTON_VIEW_SMALL_ALT', 'Смотреть');
define('BUTTON_WRITE_REVIEW_ALT', 'Написать Отзыв');
define('BUTTON_READ_REVIEWS_ALT', 'Читать Обзор');
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Перейти к подробному описанию этого товара');
define('BUTTON_MORE_REVIEWS_ALT', 'Подробные Отзывы');
?>