...
define('OTHER_BOX_NOTIFY_REMOVE_ALT', 'Удалить уведомление этого товара.');
define('OTHER_BOX_NOTIFY_YES_ALT', 'Сообщите мне о новинках к этому продукту.');
define('OTHER_BOX_WRITE_REVIEW_ALT', 'Написать отзыв на этот продукт.');
define('OTHER_CALL_FOR_PRICE_ALT', 'Позвоните для текущей цены, пожалуйста.');
define('OTHER_DOWN_FOR_MAINTENANCE_ALT', 'В настоящее время сайт закрыт на техническое обслуживание. Зайдите позже, пожалуйста.');
define('OTHER_TRANPARENT_ALT', '');
define('OTHER_IMAGE_CUSTOMERS_AUTHORIZATION_ALT', 'ОЦЕНКИ ЗАКАЗЧИКА');
define('OTHER_REVIEWS_RATING_STARS_FIVE_ALT', 'Пять Звезд');
define('OTHER_REVIEWS_RATING_STARS_FOUR_ALT', 'Четыре Звезды');
define('OTHER_REVIEWS_RATING_STARS_THREE_ALT', 'Три Звезды');
define('OTHER_REVIEWS_RATING_STARS_TWO_ALT', 'Две Звезды');
define('OTHER_REVIEWS_RATING_STARS_ONE_ALT', 'Одна Звезда');
