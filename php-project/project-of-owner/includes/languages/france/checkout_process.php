...
define('EMAIL_TEXT_SUBJECT', 'Commande de Fiberstore # %s ');
...
define('EMAIL_THANKS_FOR_SHOPPING','Merci de faire du shopping avec nous aujourd\'hui!');
...
define('EMAIL_TEXT_SUBTOTAL', 'Total partiel:');
...
define('COPY_RIGHT', 'Copyright &copy; 2009-'.date('Y',time()).' FiberStore Co., Ltd. Tous Droits Réservés.');
define('FOOTER', '<tr>
