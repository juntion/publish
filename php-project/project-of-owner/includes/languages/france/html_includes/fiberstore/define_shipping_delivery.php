...
function showDiv(n){
    ...
    <div class="page_nav">
      <div class="page_nav_con">
		...
		<a href="shipping_delivery.html" class="title_selected"><?php echo SHIPPING_4;?></a>
		</div>
      </div>
    </div>
...
<p class="return_policy_dian"><?php echo SHIPPING_35; ?><a href="mailto:legal@fs.com"><?php echo SHIPPING_42?></a><?php echo SHIPPING_41 ?></p>
     </div>
</div>
    </div>
    </div>
...
<ul><li><img src="/includes/templates/fiberstore/images/specials/shipping_delivery/shipping_way_icon01.jpg"/><p><?php echo SHIPPING_36;?></p></li>
  <li><img src="/includes/templates/fiberstore/images/specials/shipping_delivery/shipping_way_icon02.jpg"/><p><?php echo SHIPPING_37;?></p></li>
  <li><img src="/includes/templates/fiberstore/images/specials/shipping_delivery/shipping_way_icon03.jpg"/><p><?php echo SHIPPING_38;?></p></li>
  <li><img src="/includes/templates/fiberstore/images/specials/shipping_delivery/shipping_way_icon04.jpg"/><p><?php echo SHIPPING_39;?></p></li>
  <li><img src="/includes/templates/fiberstore/images/specials/shipping_delivery/shipping_way_icon05.jpg"/><p><?php echo SHIPPING_40;?></p></li>
 <!-- <li><img src="/includes/templates/fiberstore/images/specials/shipping_delivery/shipping_way_icon06.jpg"/><p><?php //echo SHIPPING_40;?></p></li> -->
  </ul>
</div>
