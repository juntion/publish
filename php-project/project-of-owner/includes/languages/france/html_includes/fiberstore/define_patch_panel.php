...
<div class="patch_contact">
  ...
  <p class="patch_contact_txt"><?php echo PATCH_PANEL_02;?>  <br />
     <?php echo PATCH_PANEL_03;?> <a href="mailto:tech@fs.com">tech@fs.com</a>  <?php echo PATCH_PANEL_04?>  <a href="mailto:fr@fs.com">fr@fs.com</a>.
    <!-- At FS.COM we regularly ask our customer, "How did we do?" and, "How could we do better?" It is a measure of our commitment to quality relationships that we constantly audit every aspect of our business. <br />You can also contact our technical support: <a href="mailto:tech@fs.com">tech@fs.com</a>, or sales team: <a href="mailto:sales@fs.com">sales@fs.com</a> if you are interested in our products.-->
  </p>
</div>
