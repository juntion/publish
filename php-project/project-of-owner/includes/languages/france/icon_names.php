...
define('ICON_TRASH_ALT', 'Supprimez cet article au panier en cliquant sur cette icône.');
define('ICON_UPDATE_ALT', 'Changez votre quantité en soulignant le nombre dans la boîte, en corrigeant la quantité et en cliquant sur ce bouton.');
