...
define('EMAIL_HOME_URL','http://www.fs.com');
define('EMAIL_MENU_SUPPORT','Support');
define('EMAIL_SUPPORT_URL','http://www.fs.com/support.html');
define('EMAIL_MENU_TUTORIAL','Tutorial');
define('EMAIL_TUTORIAL_URL','http://www.fs.com/tutorial.html');
define('EMAIL_MENU_ABOUT_US','About Us');
define('EMAIL_ABOUT_US_URL','http://www.fs.com/about_us.html');
define('EMAIL_MENU_SERVICE','Service');
define('EMAIL_SERVICE_URL','http://www.fs.com/service.html');
define('EMAIL_MENU_CONTACT_US','Contact Us');
define('EMAIL_CONTACT_US_URL','http://www.fs.com/contact_us.html');
define('EMAIL_MENU_MY_ACCOUNT','My account');
define('EMAIL_MY_ACCOUNT_URL','http://www.fs.com/index.php?main_page=my_dashboard');
define('EMAIL_MENU_CHECK_ORDER','Check Order Status');
define('EMAIL_CHECK_ORDER_URL','http://www.fs.com/index.php?main_page=manage_orders');
...
define('EMAIL_FOOTER_FS_SERVICE','<a href="https://www.fs.com/de-en/" target="_blank" style="color:#232323; text-decoration:none;">FS.COM</a> Customer Service');
define('EMAIL_FOOTER_FS_CONTACT','http://www.fs.com/de-en/contact_us.html');
/**************************************content common text**************************************/
...
// 个人用户升级企业用户邮件
define('EMAIL_UPGRADE_TO_COMPANY_CONSULT','If you have any further questions, please feel free to <a href="http://www.fs.com/contact_us.html" style="color:#0070BC; text-decoration:none;">contact us</a>.');
...
// fairy 2017.11.28
define('EMAIL_PWD_FORGOTTEN_TO_CUSTOMER_TITLE','How to reset your <a href="https://www.fs.com/de-en/" target="_blank" style="color:#232323; text-decoration:none;">FS.COM</a> account password?');
define('EMAIL_PWD_FORGOTTEN_TO_CUSTOMER_TEXT1','This email was sent to you in response to your request to modify your <a href="https://www.fs.com/de-en/" target="_blank" style="color:#232323; text-decoration:none;">FS.COM</a> account.');
define('EMAIL_PWD_FORGOTTEN_TO_CUSTOMER_TEXT2','Click the link below to go to the <a href="https://www.fs.com/de-en/" target="_blank" style="color:#232323; text-decoration:none;">FS.COM</a> site and reset your password: ');
define('EMAIL_PWD_FORGOTTEN_TO_CUSTOMER_RESET_BUTTON','Reset your password');
define('EMAIL_PWD_FORGOTTEN_TO_CUSTOMER_TEXT3','Please note that the above link has a life span of 3days only.');
define('EMAIL_PWD_FORGOTTEN_TO_CUSTOMER_TEXT4','If you didn\'t make this change or if you believe an unauthorized person has accessed your account, please <a href="RESET_PWD_LINK" target="_blank" style="color:#0070BC; text-decoration:none;">reset your password</a> immediately. Then <a href="https://www.fs.com/de-en/login.html" target="_blank" style="color:#0070BC; text-decoration:none;">sign in</a> to review and update your security settings.');
...
define('FS_PWD_UPDATE_SUCCESS_EAMIL_CON1','The password for your <a href="https://www.fs.com/de-en/" target="_blank" style="color:#232323; text-decoration:none;">FS.COM</a> ID (<a href="mailto:EMAIL_USER_EMAIL" style="color:#232323; text-decoration:none;"><b>EMAIL_USER_EMAIL</b></a>) has been successfully changed on <b>EMAIL_TIME</b>.');
define('FS_PWD_UPDATE_SUCCESS_EAMIL_CON2','You can now use your new security info to sign in to your account. If you need additional help, please <a href="https://www.fs.com/de-en/contact_us.html" target="_blank" style="color:#0070BC; text-decoration:none;">contact us</a>.');
define('FS_PWD_UPDATE_SUCCESS_EAMIL_CON3','If you didn\'t make this change or if you believe an unauthorized person has accessed your account, pleas <a href="https://www.fs.com/de-en/password_forgotten.html" target="_blank" style="color:#0070BC; text-decoration:none;">reset your password</a> immediately. Then <a href="https://www.fs.com/de-en/login.html" target="_blank" style="color:#0070BC; text-decoration:none;">sign in</a> to review and update your security settings.');
...
//2017-12-7  add   ery 
define('EMAIL_CHECKOUT_COMMON_SUCCESS_TITLE','FS.COM - Thanks for your Order %s');
...
define('EMAIL_CHECKOUT_WOW_TO_CUSTOMER_INTRODUCTION_WESTERN_UNION','Thank you for ordering from FS.COM! We have received your order and are awaiting payment confirmation.<br>
							...
							Please visit <a target="_blank" href="http://www.fs.com/manage_orders.html" style="color:#363636;">My Orders</a> to view our Western Union account information if you have not taken down the account information during the check out process .<br><br>
...
define('EMAIL_CHECKOUT_WOW_TO_CUSTOMER_INTRODUCTION_WIRE_TRANSFER','<p>Thank you for ordering from FS.COM! We have received your order and   are awaiting payment confirmation.<br>
      ...
      Please visit <a target="_blank" href="http://www.fs.com/manage_orders.html" style="color:#363636;">My Orders</a> to view our Bank Transfer account information if you have not taken down the   account information during the check out process .</p>
...
define("EMAIL_CHECKOUT_WOW_TO_CUSTOMER_START1","Thank you for the PO documents, you could view the PO via  <a href='http://www.fs.com/index.php?main_page=manage_orders'  target='_blank'>'My orders'</a>.");
...
define("EMAIL_CHECKOUT_WOW_TO_CUSTOMER_START3","If you have any question, please feel free to <a href='http://www.fs.com/contact_us.html'  target='_blank'>contact us</a>.");
...
define('EMAIL_CHECKOUT_PAYPAL_TEXT4','! Below is summary of your latest open order. Just one last step to finish payment, all will be yours.');
...
define('EMAIL_CHECKOUT_PAYPAL_TEXT7','contact us');
...
define('EMAIL_CHECKOUT_PAYMENT_SUCCESS_TEXT1','Thanks for shopping with Fiberstore. We have received the payment and will process your order as soon as possible. If you have any question, please feel free to <a href="http://www.fs.com/customer_service.html" target="_blank">contact us</a>.');

/*********************************** orders status *************************************/
define('EMAIL_ORDERS_STATUS_SUBJECT','Order Update # ');
define('EMAIL_ORDERS_STATUS_FOR_ORDER','For Order No:');
define('EMAIL_ORDERS_STATUS_TEXT1','the status is changed. Please go to <a href="http://www.fs.com/index.php?main_page=account_history_info&orders_id=$ORDER_ID">My orders</a> on www.fs.com to check the	details.');
...
define('FS_OFFSITE_LOGIN_EAMIL_CONTENT3','If you have any more questions, please feel free to <a href="https://www.fs.com/de-en/contact_us.html" target="_blank" style="color:#0070BC; text-decoration:none;">contact us</a>.');
...
define('EMAIL_RMA_SUCCESS_APPROVED_WE','We\'ll process the %s once we receive the package. For immediate help, please feel free to <a href="http://www.fs.com/de-en/contact_us.html" target="_blank" style="color:#0070BC; text-decoration:none;">contact us</a>.');
...
define('EMAIL_RMA_SUCCESS_SUBMIT_FOR','For immediate help, please feel free to <a href="http://www.fs.com/de-en/contact_us.html" target="_blank" style="color:#0070BC; text-decoration:none;">contact us</a>.');
...
define('FS_MODIFY_PWD_EAMIL_SUCCESS_CONTENT1','The password for your <a href="https://www.fs.com/de-en/" target="_blank" style="color:#232323; text-decoration:none;">FS.COM</a> ID (<a href="mailto:EMAIL_USER_EMAIL" style="color:#232323; text-decoration:none;"><b>EMAIL_USER_EMAIL</b></a>) has been successfully changed on <b>EMAIL_TIME</b>.');
define('FS_MODIFY_PWD_EAMIL_SUCCESS_CONTENT2','You can now use your new security info to sign in to your account. If you need additional help, please <a href="https://www.fs.com/de-en/contact_us.html" target="_blank" style="color:#0070BC; text-decoration:none;">contact us</a>.');
define('FS_MODIFY_PWD_EAMIL_SUCCESS_CONTENT3','If you didn\'t make this change or if you believe an unauthorized person has accessed your account, please <a href="https://www.fs.com/de-en/password_forgotten.html" target="_blank" style="color:#0070BC; text-decoration:none;">resert your password</a> immediately.  Then <a href="https://www.fs.com/de-en/login.html" target="_blank" style="color:#0070BC; text-decoration:none;">sign in</a> and update your security settings.');
...
define('FS_MODIFY_EMAIL_SUCCESS_EAMIL_CONTENT2','You can now use your new address to sign in to your account. If you need additional help, please <a href="https://www.fs.com/de-en/contact_us.html" target="_blank" style="color:#0070BC; text-decoration:none;">contact us</a>.');
define('FS_MODIFY_EMAIL_SUCCESS_EAMIL_CONTENT3','If you didn\'t make this change or if you believe an unauthorized person has accessed your account, please <a href="https://www.fs.com/de-en/password_forgotten.html" target="_blank" style="color:#0070BC; text-decoration:none;">resert your password</a> immediately.  Then <a href="https://www.fs.com/de-en/login.html" target="_blank" style="color:#0070BC; text-decoration:none;">sign in</a> and update your security settings.');
...
define('FS_APPLY_INQUIRY_EAMIL_SUCCESS_CONTENT3','If you\'re a registered member, you could track and review the quote details via <a href="https://www.fs.com/de-en/inquiry_list.html" style="color: #0070BC;">account center</a>.');
