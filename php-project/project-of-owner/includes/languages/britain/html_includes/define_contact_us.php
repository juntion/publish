...
<div class="contact_us">
  ...
  ?>
   ...
   if($countryCode==ES){
    ...
    if($countryCode==SG){
         echo '<span class="tit02"><a href="tel:+(65) 3163 0003">+(65) 3163 0003</a></span> ';
		}
	if($countryCode==TW){
  ...
  <div class="contact_con">
    ...
    <div class="contact_right">
          ...
          <div class="contact_phone4 contact_show" style="display:none">
            <table width="100%" border="0">
              <tr>
                ...
                <td><a href="tel:+(65) 3163 0003">+(65) 3163 0003</a></td>
              </tr>
              <tr>
      ...
      <div class="contact_right02">
        <div class="sedebar_contact01 "> <a target="_blank" href="<?php echo reset_url('service/fs_support.html');?>">
          <dl>
