...
<div class="page_nav">
      <div class="page_nav_con">
        ...
        <div class="short_title"><a class="title_selected" href="<?php echo zen_href_link(FILENAME_OEM);?>"><?php echo FS_FOOTER_OEM;?></a><a href="<?php echo zen_href_link(FILENAME_DAY_RETURN_POLICY);?>"><?php echo FS_FOOTER_POLICY;?></a><a href="<?php echo zen_href_link(FILENAME_WARRANTY);?>"><?php echo FS_FOOTER_WARRANTY;?></a><a href="<?php echo zen_href_link('quality_control');?>"><?php echo FS_FOOTER_QUALITY;?></a><a href="/partner.html"><?php echo FS_FOOTER_PARTNER;?></a></div>
      </div>
    </div>
...
<div class="oem_customs_con">
  ...
  <div class="categories_select">
    <ul>
      <li class="select01"><a href="https://www.fs.com<?php echo $code;?>/c/data-center-solutions-1308" target="_blank"><span><?php echo FS_OEM_CLOUD;?></span></a></li>
      <li class="select02"><a href="https://www.fs.com<?php echo $code;?>/support/custom-wdm-otn-solutions-for-long-haul-applications-100" target="_blank"><span><?php echo FS_OEM_TRANSMISSON;?></span></a></li>
      <li class="select03"><a href="https://www.fs.com<?php echo $code;?>/Enterprise-Networks.html" target="_blank"><span><?php echo FS_OEM_ACCESS;?></span></a></li>
    </ul>
  </div>
  <div class="ccc"></div>
