<div class="alone_banner purchase_help">
        ...
        <div class="purchaseHelp_content_listbox">
            <div class="alone_after return_padding">
                ...
                <div  class="purchaseHelp_right">
                    <div class="purchaseHelp_right_cont">
                        <h1 class="purchaseHelp_right_tit first_z"><?php echo FS_HOW_TO_BUY_03; ?></h1>
                        ...
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                <p class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_36; ?> "<a href="<?php echo $code;?>/index.php?main_page=manage_addresses"><?php echo FS_HOW_TO_BUY_37; ?></a>". <?php echo FS_HOW_TO_BUY_38; ?> <?php echo FS_HOW_TO_BUY_39; ?> </p>
                        ...
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                ...
                                <ul class="hasDot_ul">
                                    ...
                                    <li><?php echo FS_HOW_TO_BUY_48; ?><a href="<?php echo $code;?>/service/fs_support.html"><?php echo FS_HOW_TO_BUY_49; ?></a>.
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="purchaseHelp_right_cont">
                        ...
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
								...
								<p class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_78_01; ?></p>
                    ...
                    <div class="purchaseHelp_right_cont">
						...
						<div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
								...
								<p class="purchaseHelp_right_txt1"><?php echo FS_HOW_TO_BUY_162; ?> <a href="<?php echo $code;?>/net_30.html"><?php echo FS_HOW_TO_BUY_163; ?></a></p>
                            </div>
                        </div>
						<div class="pur_qa_con">
                    ...
                    <div class="purchaseHelp_right_cont">
                        ...
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                ...
                                <p class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_137; ?> <a href="<?php echo $code;?>/policies/day_return_policy.html"><?php echo FS_HOW_TO_BUY_138; ?></a> <?php echo FS_HOW_TO_BUY_139; ?></p>
                            </div>
                        </div>
                        <div class="pur_qa_con">
                            ...
                            <div class="pur_qa_con_main choosez">
                                ...
                                <p class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_142; ?> "<a href="<?php echo $code;?>/warranty.html"><?php echo FS_HOW_TO_BUY_143; ?></a>" <?php echo FS_HOW_TO_BUY_144; ?></p>
                            </div>
                        </div>
                        <div class="pur_qa_con">
...
$(function(){
    var _this;
	var _Height;
	var _height = $('.purchaseHelp_left').offset().top; 
	...
	$(window).bind("scroll", function(){
		...
		if ($(window).scrollTop() > heightLT) {
			if(heightR >= $(window).scrollTop()+heightL){
				...
				$('.purchaseHelp_left_fix').css({"position":"relative","margin-top":_heightR-heightL+'px',"top":0}).removeClass('choosez')
			}
		}else{
