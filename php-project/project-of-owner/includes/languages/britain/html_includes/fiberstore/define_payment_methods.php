                ...
                <div class="compare-features-main">
                    <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td><?php echo PAYMENT_METHODS_TABLE_CONTENT_08;?></td>
                            <td><?php echo PAYMENT_METHODS_TABLE_CONTENT_04;?></td>
        ...
        <div class="payThods-popup-content">
            <div class="payThods-txtBox choosez">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="sgBank-popup-ta">
                    ...
                    <tr>
                        <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_CONTENT_05;?></th>
                        <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_CONTENT_06;?></b></td>
                    </tr>
                    <tr>
                        <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_CONTENT_07;?></th>
                        <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_CONTENT_08;?></b></td>
                    </tr>
                    <tr>
                        <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_CONTENT_09;?></th>
                        <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_CONTENT_10;?></b></td>
                    </tr>
                    <tr>
                        <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_CONTENT_11;?></th>
                        <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_CONTENT_12;?></b></td>
                    </tr>
                    </tbody>
                </table>
            </div>
