...
$listing_split = new splitPageResults ( $weekly_deals_query, $page_size, 'p.products_id', 'page' );
?><div
	class="currentPath"><a
	href="<?php
	echo zen_href_link ( FILENAME_DEFAULT );
	?>">Home</a><em>&gt;</em><span>Weekly
Deals</span></div>
...
if ($listing_split->number_of_rows > 0) {
	...
	<p class="tc"><a
		...
		?>"><img
		src="<?php
		echo DIR_WS_IMAGES . $listing->fields ['products_image']?>"
