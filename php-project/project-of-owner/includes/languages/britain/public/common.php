...
define('COMMON_SERVICE_18','FS gets inspiration from our employees that contributes to how we operate and we always encourage our team to share their ideas. That\'s the reason');
define('COMMON_SERVICE_19','why FS provides a great service to our customers around the world and we aim to continually improve and develop. You can know more about our team on the <a class="alone_a01" href="'.reset_url('my_team.html').'"> my team </a> page.');
...
define('FS_FOOTER_OUR_PARTNERS','Our Partners');
...
define('FS_FOOTER_PARTNERS','FS Partners:');
...
// 2018.7.5/7.14 小语种/英文新版首页上线 fairy 新版 新增
define("FS_FOOTER_COPYRIGHT","Copyright © 2009-YEAR ".FS_LOCAL_COMPANY_NAME." Regus Edmund House, 12-22 Newhall Street, Birmingham, B3 3AS. Registered Number: 10876330. VAT Number: 277384560");
define("FS_FOOTER_COPYRIGHT_M","Copyright © 2009-YEAR <span>".FS_LOCAL_COMPANY_NAME." </span> Regus Edmund House, 12-22 Newhall Street, Birmingham, B3 3AS. Registered Number: 10876330. VAT Number: 277384560");
...
define('FS_HEADER_NEWS_DES','<dd>FS provides tailored, cost-effective network solutions for your business. Our products and service is trusted by some of the world\'s most influential corporations.</dd>');
