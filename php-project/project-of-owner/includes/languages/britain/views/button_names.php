...
define('BUTTON_ADD_TO_CART_ALT', 'Add This to My Basket');
define('BUTTON_ADD_ADDRESS_ALT', 'Add Address');
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT','Add Selected Products to Basket');
...
define('BUTTON_IN_CART_ALT', 'Add to Basket');
