<?php
//2018-9-17   ery  add  http://test.whgxwl.com:8000/customer_service_others.html
...
define('FS_CUSTOMER_SERVICE_16','By clicking the button below, you agree to FS.COM\'s <a href="'.zen_href_link('privacy_policy').'">Privacy and Cookies</a> and <a href="'.zen_href_link('terms_of_use').'">Term and Conditions</a>.');
