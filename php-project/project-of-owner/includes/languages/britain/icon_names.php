...
define('ICON_IMAGE_TINYCART', 'basket.gif');

//alt tags for buttons
define('ICON_ERROR_ALT', 'Error');
define('ICON_SUCCESS_ALT', 'Success');
define('ICON_WARNING_ALT', 'Warning');
define('ICON_TRASH_ALT', 'Delete this item from the basket by clicking this icon.');
...
define('ICON_TINYCART_ALT', 'Add this product to your basket by clicking here.');
