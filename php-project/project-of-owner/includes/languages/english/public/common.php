...
define('COMMON_SERVICE_02','FS focuses on data center, enterprise and optical transmission network solution to help you build exactly what you need. <br> Get in touch, we are here to help 24/7. ');
...
define('FS_SAVE_CSRT_LIMIT_TIP','Please enter the cart name maximum 50 words.');
...
// 2018.7.5/7.14 小语种/英文新版首页上线 fairy 新版 新增
define("FS_FOOTER_COPYRIGHT","Copyright © 2009-YEAR ".FS_LOCAL_COMPANY_NAME." All Rights Reserved.");
...
if($_SESSION['languages_code']=='sg'){
    define('FS_SITE_UNIQUE_LANGUAGE_ID','13');
}else{
    define('FS_SITE_UNIQUE_LANGUAGE_ID','1');
}
// 配置文件 end
...
define('PATCH_PANEL_02','FS focus on data center, enterprise and optical transmission network solution to help you build exactly what you need.');
define('PATCH_PANEL_03','Email us at <a href="mailto:tech@fs.com">tech@fs.com</a> or <a href="mailto:sales@fs.com">sales@fs.com</a>.');
...
//左上角  俄罗斯国家展示邮箱
define('FS_HEADER_EMAIL','<span>Email Us: <a href="mailto:sales@fs.com">ru@fs.com</a></span>');
...
define('NEW_PATCH_PANEL_07', 'Cost-Efficient Deal');
...
//define('CUSTOMER_SERVICE_OTHERS_46', 'Have an Existing Account?');
...
define('META_TAGS_SHOPPING_CART_TITLE', 'Shopping Cart');
...
define('META_TAGS_SAVED_ITEMS_TITLE', 'Saved Carts');
define('META_TAGS_SAVED_ITEMS_DESCRIPTION', 'After you add items to cart, click "Save Cart" to save collections of items. You can create as many saved carts as you would like, and you can use saved carts for repeated orders.');
...
define('FS_HEADER_CUSTOMER_URL_12','Create Quote');
...
define('FS_HEADER_NEWS_READ_MORE','<a class="home_solution_sub_level_right_dd_a" href="https://community.fs.com/news"><span>Read more</span><i class="iconfont icon">&#xf089;</i></a>');
define('FS_HEADER_NEWS_DES','<dd><a href="https://community.fs.com/news/fs-announces-the-new-arrival-of-massive-400g-qsfp-dd-module-and-dac-inventory.html" target="_blank">New Arrival of Massive FS 400G QSFP-DD Module & DAC Inventory</a></dd>
<dd><a href="https://community.fs.com/news/fs-enterprise-campus-wired-and-wireless-solutions.html" target="_blank">FS Enterprise Campus Wired & Wireless Solutions </a></dd>
<dd><a href="https://community.fs.com/news/fs-com-updates-a-series-of-400g-modules-and-dac-cables-for-dc.html" target="_blank">FS Updates a Series of 400G Modules and DAC Cables for DC (26/10/2020 Updated)</a></dd>
<dd><a href="https://community.fs.com/news/fs-com-and-us-conec-partner-on-supplying-mtpr-series-products.html" target="_blank">FS.COM and US Conec Partner on Supplying MTP® Series Products</a></dd>
<dd><a href="https://community.fs.com/news/fs-hands-over-isolation-gowns-assist-new-yorks-covid-19-fight.html" target="_blank">FS Hands Over 1000 Isolation Gowns to Assist New York\'s COVID-19 Fight</a></dd>');
...
define('FS_ACCOUNT_TW_VIEW_CART','View Cart');
...
define('FS_ACCOUNT_TW_THE','The following product(s) cannot be ordered again directly for the specific reason below.Click the button "Skip and Continue" to add the remaining product(s) to cart again.');
...
define('FS_ACCOUNT_TW_YOU_CAN','You can use this button to bring all the products in this order into cart again.');
...
define('FS_ACCOUNT_TW_QUOTES_LIST_TIPS','Add the below product(s) to Cart, and Create Quote.');
...
define('FS_ACCOUNT_TW_QUOTE_AGAIN_TIPS2','The following product(s) cannot be quoted again directly for the specific reason below. Click the botton "Skip and Continue" to add the remaining product(s) to cart again and create quote.');
...
define('TIPS_NEW', 'New');
define('FS_ATTRIBUTE_CUSTOMIZED','Customized');
//warranty 新增分类质保信息
