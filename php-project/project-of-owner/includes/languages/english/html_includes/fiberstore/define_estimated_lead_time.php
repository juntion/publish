<div class="page_nav">
      <div class="page_nav_con">
        ...
        <div class="short_title"><a href="<?php echo zen_href_link('payment_methods');?>"><?php echo FS_TIME_PAYMENT;?></a><a href="<?php echo zen_href_link('net_30');?>"><?php echo FS_TIME_NET30_W9;?></a><a href="<?php echo zen_href_link('estimated_lead_time');?>" class="title_selected"><?php echo NAVBAR_TITLE;?></a></div>
      </div>
    </div>
