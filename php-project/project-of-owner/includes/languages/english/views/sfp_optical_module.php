<?php
define('FS_SFP_OPTICAL1','<p class="new_10g_banner_tit">Stock List of 10G CWDM/DWDM SFP+</p>');
define('FS_SFP_OPTICAL2','Same-day shipping');
define('FS_SFP_OPTICAL3','Global Warehouse, Same-day Shipping');
define('FS_SFP_OPTICAL4',"Holding a large inventory of popular transceivers in our five local warehouses in Europe, North America, Asia, and Oceania, FS is available to make sure your order gets to you on time.");
...
define('FS_SFP_OPTICAL79','Related Solutions');
