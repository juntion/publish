...
define('FS_SHIPPING_02','Information about delivery options, delivery rates and delivery time.');
define('FS_SHIPPING_03','Free Delivery for Orders Over AU$99');
...
define('FS_SHIPPING_10','Free Delivery for Orders Over AU$99');
...
define('FS_SHIPPING_11_A_10','For eligible products (except for those listed below), orders over AU$99 and dispatched from AU warehouse can enjoy FREE delivery by Fastway Courier.');
...
define('FS_SHIPPING_12',"Heavy or oversize items as following can't enjoy free delivery:");
...
<a class="alone_txt return_left qaf_padding color_Blue" href="/c/odf-box-13">Optical Distribution Frames</a>,
<a class="alone_txt return_left qaf_padding color_Blue" href="/c/splice-closure-17">Fiber Optic Splice Closure</a>, 
<a class="alone_txt return_left qaf_padding color_Blue" href="/c/hot-in-stock-terminal-box-16">Fiber Termination Box</a>, 
<a class="alone_txt return_left qaf_padding color_Blue" href="/c/indoor-outdoor-multifibre-cables-1155">Indoor/Outdoor Multifiber Cables</a>,
<a class="alone_txt return_left qaf_padding color_Blue" href="/c/military-grade-fibre-cables-1148">Military Grade Fiber Cables</a>,
<a class="alone_txt return_left qaf_padding color_Blue" href="/c/open-frame-racks-2907">Open Frame Racks</a>, 
<a class="alone_txt return_left qaf_padding color_Blue" href="/c/server-network-cabinets-900">Server/Network Cabinets</a>, 
<a class="alone_txt return_left qaf_padding color_Blue" href="/c/wall-mount-cabinets-3093">Wall Mount Cabinets</a>, 
<a class="alone_txt return_left qaf_padding color_Blue" href="/c/outside-wall-mount-enclosures-2969">Outside Wall Mount Enclosures</a>,
<a class="alone_txt return_left qaf_padding color_Blue" href="/c/bulk-fiber-cable-573">Bulk Fiber Cables</a>, 
<a class="alone_txt return_left qaf_padding color_Blue" href="/c/shelves-accessories-3059">Shelves & Accessories</a>, 
<a class="alone_txt return_left qaf_padding color_Blue" href="/c/ups-power-supply-3260">UPS Power Supply</a>, 
<a class="alone_txt return_left qaf_padding color_Blue" href="/c/raceway-system-3319">Fiber Raceway System</a>, 
<a class="alone_txt return_left qaf_padding color_Blue" href="/c/bulk-cables-629">Bulk Cables</a>,
<a class="alone_txt return_left qaf_padding color_Blue" href="/c/ip67-waterproof-fiber-cables-1342">IP67 Waterproof Fiber Cables</a> and  
<a class="alone_txt return_left qaf_padding color_Blue" href="/c/polarization-maintaining-pm-fibre-cables-996">Polarization Maintaining(PM) Fiber Cables</a>');
define('FS_SHIPPING_15','57-59 Edison Rd, Dandenong South, <br />VIC 3175, Australia <br />Tel: +61 (2) 8317 1119 <br />ABN: 71 620 545 502');
...
define('FS_SHIPPING_18','Orders over AU$99 with eligible items dispatched from AU warehouse can enjoy FREE delivery by Fastway Courier.');
...
define('FS_SHIPPING_102','FS.COM provides 30-day none-reason return & exchange service. For this service, we will undertake the shipping fee’s both ways if the return is caused in fault of FS.COM, such as a quality issue. For more details, please click');
...
define('FS_SHIPPING_129','TNT overnight door-to-door delivery service ensures your shipment arrives by 5pm on the next business day.');
...
define('FS_SHIPPING_135',"At the start of business, TNT 9:00 Express service makes sure your parcel is there. TNT's fastest door-to-door overnight service with a delivery time of 9:00am to and from nominated postcodes Australia-wide.");
...
define('FS_SHIPPING_140',"Note: If parcels are shipped by TNT and no one is available to accept the delivery, a calling card will be left to arrange a second delivery or inform you to pick up from the designated depot. For re-delivery, you will be charged. And to learn more details about TNT's Time Critical services, you can visit https://www.tnt.com/express/en_au/site/shipping-services/courier-services.html.");

define('FS_SHIPPING_141',"About Delivery Cost");
define('FS_SHIPPING_142',"Exact delivery cost will be determined at the time of checkout based on the number of items, item type, weight, and volume of all the items in the shopping cart. You can find the cost in order summary at checkout page. FS.COM Pyt Ltd. does NOT charge any hidden fees for orders.");

define('FS_SHIPPING_143',"Products in stock");
define('FS_SHIPPING_144',"Orders sufficient in stock will be dispatched at the same day or next business day.");
define('FS_SHIPPING_145',"Customized Products");
define('FS_SHIPPING_146',"The delivery date is stated beside “customized” in product page. Usually the preparation may take weeks.");
define('FS_SHIPPING_147',"Products out of stock");
define('FS_SHIPPING_148',"If your order contains items our of stock in AU warehouse right now, a partial shipment will be generated with no additional cost. The in-stock items will be shipped first. And the rest will be shipped out upon arriving at our warehouse in Melboure, Australia.");
define('FS_SHIPPING_149',"The availability of products at FS.COM is subject to change. Once you confirm the order, the inventory will be updated real-time to ensure our customers can manage their purchase plan well. You may find inventory details of each specific item right above the “Add to Cart” icon on the product page. Once you place the order, you can check the estimated delivery date for all products in order details page.");

define('FS_SHIPPING_150',"GST & TARIFF");
define('FS_SHIPPING_151',"GST in Australia");
define('FS_SHIPPING_152',"In accordance with the <em class='alone_font_italic'>A New Tax System (Goods and Services Tax) Act 1999</em>, FS.COM Pyt Ltd. is obliged to charge GST on all orders delivered to customers located within Australia. All items in our category are subject to the regular GST rate of 10% accordingly.");
...
define('FS_SHIPPING_175',"FS.COM Pyt Ltd. offers the following delivery options. You can choose according to different time schedules and budgets.");
?>