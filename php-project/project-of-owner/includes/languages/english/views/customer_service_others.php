...
define('FS_CUSTOMER_SERVICE_16','By clicking the button below, you agree to FS.COM\'s <a href="'.reset_url('policies/privacy_policy.html').'">Privacy and Cookies</a> and <a href="'.reset_url('policies/terms_of_use.html').'">Term and Conditions</a>.');
...
define('FS_CUSTOMER_SERVICE_25','This is an online order. Please apply for the return in your <a href="'.zen_href_link('manage_orders').'">account center</a>.');
define('FS_CUSTOMER_SERVICE_26','Order Number');
//邮件
define('FS_CUSTOMER_SERVICE_27','Your RMA request # %s is under review.');	//submit 状态邮件标题
define('FS_CUSTOMER_SERVICE_35','Your RMA request # %s has been approved.');	//approved 状态邮件标题
define('FS_CUSTOMER_SERVICE_36','Your RMA request has been approved. For further information about the process, your dedicated sales representatives will contact you promptly.');	//approved 状态邮件内容
define('FS_CUSTOMER_SERVICE_28','Dear %s,');
define('FS_CUSTOMER_SERVICE_29','We have received your RMA application and will have a quick review. For further information about the process, your dedicated sales representatives will contact you promptly.'); //submit 状态邮件内容
...
define('FS_CUSTOMER_PRIVACY_POLICY','Please make sure you agree to our Privacy Policy and Terms of Use.');
