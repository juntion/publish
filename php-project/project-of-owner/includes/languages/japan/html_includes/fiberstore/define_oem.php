...
<div class="page_nav">
      <div class="page_nav_con">
        ...
        <div class="short_title"><a class="title_selected" href="<?php echo zen_href_link(FILENAME_OEM);?>"><?php echo FS_FOOTER_OEM;?></a><a href="<?php echo zen_href_link(FILENAME_DAY_RETURN_POLICY);?>"><?php echo FS_FOOTER_POLICY;?></a><a href="<?php echo zen_href_link(FILENAME_WARRANTY);?>"><?php echo FS_FOOTER_WARRANTY;?></a><a href="<?php echo zen_href_link('quality_control');?>"><?php echo FS_FOOTER_QUALITY;?></a><a href="<?php echo zen_href_link('partner','','SSL');?>"><?php echo FS_FOOTER_PARTNER;?></a></div>
      </div>
    </div>
...
<div class="oem_customs_con">
  ...
  <div class="oem_customs_type_bg"></div>
    <ul>
      <li>
        <dl>
          <dt><a href="<?php echo $code;?>/c/fiber-optic-cables-209" target="_blank"><img src="/images/img/2016oem_pic01.png" alt="FiberStore.png"></a></dt>
          <dd><span><?php echo FS_OEM_ASSEMBLIES;?></span>
            <p><?php echo FS_OEM_SUPPLIER;?> </p>
            <a href="<?php echo $code;?>/c/fiber-optic-cables-209" target="_blank"><?php echo FS_OEM_VIEW_MORE;?><img src="/images/img/2016oem_jian.png" alt="FiberStore.jpg"></a> </dd>
        </dl>
      </li>
      <li>
        <dl>
          <dt><a href="<?php echo $code;?>/c/fiber-optic-transceivers-9" target="_blank"><img src="/images/img/2016oem_pic02.png" alt="FiberStore.png"></a></dt>
          <dd><span><?php echo FS_OEM_MODULES;?></span>
            <p><?php echo FS_OEM_GUIDE;?></p>
            <a href="<?php echo $code;?>/c/fiber-optic-transceivers-9" target="_blank"><?php echo FS_OEM_VIEW_MORE;?><img src="/images/img/2016oem_jian.png" alt="FiberStore.jpg"></a> </dd>
        </dl>
      </li>
      <li>
        <dl>
  ...
  <div class="categories_select">
    <ul>
      <li class="select01"><a href="<?php echo $code;?>/c/data-center-solutions-1308" target="_blank"><span><?php echo FS_OEM_CLOUD;?></span></a></li>
  ...
  <div class="oem_customs_catalog_btn"><a href="show_all_categories.html" target="_blank"><?php echo FS_OEM_BROWSE;?> <img src="/images/img/2016oem_jian.png" alt="FiberStore.jpg"></a></div> -->
