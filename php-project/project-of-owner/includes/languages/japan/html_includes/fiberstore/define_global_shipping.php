...
<div class="page_nav">
	<div class="page_nav_con">
		<div class="big_title"><a>支払い & 配送</a>
		</div>
		<div class="short_title"><a href="<?php echo zen_href_link(FILENAME_PAYMENT_METHODS);?>">支払い方法</a><a href="<?php echo zen_href_link('net_30');?>">Net 30 & W9</a><a href="<?php echo zen_href_link(FILENAME_GLOBAL_SHIPPING);?>" class="title_selected">配送ガイド</a><a href="<?php echo zen_href_link(FILENAME_ESTIMATED_TIME);?>">配達 & 出荷</a></div>
	</div>
</div>
...
<div class="payment_con">
	...
	<div align="center">
		...
		<div class="Pie_shape">
			<dl><dt><span class="bule"></span></dt><dd>ご注文した商品はお支払い後1~2日に配送されます</dd></dl>
			<dl><dt><span class="green"></span></dt><dd>3営業日</dd></dl>
			<dl><dt><span class="orange"></span></dt><dd>4営業日</dd></dl>
			<dl><dt><span class="purple"></span></dt><dd>1週間以内</dd></dl>
			<dl><dt><span class="red"></span></dt><dd>1週間以上</dd></dl>
		</div>
	</div>
