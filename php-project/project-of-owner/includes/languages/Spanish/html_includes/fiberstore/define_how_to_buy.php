  ...
  <div class="page_nav">
    <div class="page_nav_con">
      ...
      <div class="short_title">
        ...
        <a href="<?php echo zen_href_link('faq','','SSL');?>">FAQ</a>
      ...
      <li>
        ...
        <div class="Pu_public">
		  <dl class="Pu_public_dl">
            ...
            <dd>
              <p><?php echo FS_HOW_TO_BY_94;?> <a href="<?php echo $code.'/';?>">www.fs.com/mx/</a>. <?php echo FS_HOW_TO_BY_95;?></p>
  ...
  <div class="Pu_bottom">
    ...
    <p>
      <?php echo FS_HOW_TO_BY_90; ?>
        <a href="<?php echo zen_href_link('customer_service','','SSL',true);?>">
          <?php echo FS_HOW_TO_BY_91; ?></a><?php echo FS_HOW_TO_BY_92; ?></p>
  </div>
...
<?php }elseif($_SESSION['languages_code'] == 'es'){?>
             ...
             <div  class="purchaseHelp_right">
                 ...
                 <div class="purchaseHelp_right_cont">
                     ...
                     <div class="pur_qa_con">
                         ...
                         <div class="pur_qa_con_main choosez">
                             <p class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_99; ?> <a href="<?php echo zen_href_link('partner','','SSL');?>"><?php echo FS_HOW_TO_BUY_100; ?></a>, <?php echo FS_HOW_TO_BUY_101; ?></p>
                         </div>
                     </div>
                 </div>
                 <div class="purchaseHelp_right_cont">
                 ...
                 <div class="purchaseHelp_right_cont">
                     ...
                     <div class="pur_qa_con">
                         ...
                         <div class="pur_qa_con_main choosez">
                             ...
                             <p  class="purchaseHelp_right_txt"><?php echo FS_HOW_TO_BUY_126; ?> "<a href=" <?php echo zen_href_link('inquiry_list','','SSL');?>"><?php echo FS_HOW_TO_BUY_127; ?></a>". <?php echo FS_HOW_TO_BUY_128; ?></p>
                         </div>
                     </div>
                     <div class="pur_qa_con">
