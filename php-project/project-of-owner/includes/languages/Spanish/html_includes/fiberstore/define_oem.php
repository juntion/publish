...
<div class="oem_customs_con">
  ...
  <div class="categories_select">
    <ul>
      ...
      <li class="select02"><a href="<?php echo $code;?>/support/custom-wdm-otn-solutions-for-long-haul-applications-100" target="_blank"><span><?php echo FS_OEM_ACCESS;?></span></a></li>
      <li class="select03"><a href="<?php echo $code;?>/Enterprise-Networks.html" target="_blank"><span><?php echo FS_OEM_TRANSMISSON;?></span></a></li>
    </ul>
  </div>
  <div class="ccc"></div>
  ...
  <div class="oem_customs_catalog_btn"><a href="<?php echo zen_href_link('show_all_categories','','SSL',true);?>" target="_blank"><?php echo FS_OEM_BROWSE;?> <img src="/images/img/2016oem_jian.png" alt="FiberStore.jpg"></a></div>
