<?php if ($_SESSION['languages_code'] == 'es') { ?>
            ...
            <div class="alone-page-content-right">
                ...
                <div class="payment-options">
                    <ul>
                        ...
                        <li class="payment-options-con">
                            <div class="payment-options-con-tit">
                                <img src="<?php echo HTTPS_IMAGE_SERVER; ?>includes/templates/fiberstore/images/specials/payment_met/vorkasse-grey.svg"
                                     width="66">
                                <span><?php echo PAYMENT_METHODS_BANK_TRANSFER; ?></span>
                            </div>
                            <p class="payment-options-con-txt">   <?php echo PAYMENT_METHODS_BANK_TRANSFER_CONTENT_01; ?></p>
                            <div class="payment-options-con-href">
                        ...
                        <li class="payment-options-con">
                            <div class="payment-options-con-tit">
                                <img src="<?php echo HTTPS_IMAGE_SERVER; ?>includes/templates/fiberstore/images/specials/payment_met/ideal.svg"
                                     width="24">
                        ...
                        <li class="payment-options-con">
                            <div class="payment-options-con-tit">
                                <img src="<?php echo HTTPS_IMAGE_SERVER; ?>includes/templates/fiberstore/images/specials/payment_met/sofortuberweisung.svg"
                                     width="43">
                ...
                <div class="payThods-txtBox choosez">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="direct-popup-ta">
                        ...
                        <?php if ($_SESSION['currency'] == 'USD') { ?>
                            <tr>
                                <th width="200"
                                    valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_02; ?></th>
                                <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_03; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_04; ?></th>
                                <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_05; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_06; ?></th>
                                <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_07; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_08; ?></th>
                                <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_09; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_10; ?></th>
                                <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_11; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_12; ?></th>
                                <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_13; ?></b>
                                </td>
                            </tr>
                        <?php } elseif ($_SESSION['currency'] == 'GBP') { ?>
                            ...
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_06; ?></th>
                                <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_14; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_08; ?></th>
                            ...
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_10; ?></th>
                                <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_15; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_12; ?></th>
                        ...
                        <?php } elseif ($_SESSION['currency'] == 'CHF') { ?>
                            ...
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_06; ?></th>
                                <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_16; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_08; ?></th>
                            ...
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_10; ?></th>
                                <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_17; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_12; ?></th>
                        ...
                        <?php } elseif ($_SESSION['currency'] == 'SEK') { ?>
                            ...
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_06; ?></th>
                                <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_18; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_08; ?></th>
                            ...
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_10; ?></th>
                                <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_19; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_12; ?></th>
                        ...
                        <?php } else { ?>
                            ...
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_06; ?></th>
                                <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_20; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_08; ?></th>
                            ...
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_10; ?></th>
                                <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_21; ?></b>
                                </td>
                            </tr>
                            <tr>
                                <th valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_12; ?></th>
                                <td valign="top"><b><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_22; ?></b>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
...
<?php } elseif ($warehouse == 'us') { //美国仓?>
    ...
    <div class="alone-page-content">
        <div class="alone-page-content-main">
            ...
            <div class="alone-page-content-right">
                <h2 class="alone-page-content-right-tit">
                    <?php echo PAYMENT_METHODS_PAYMENT_OPTIONS; ?>
                </h2>
                <div class="payment-options">
                    <ul>
                        <li class="payment-options-con">
                        ...
                        <li class="payment-options-con">
                            <div class="payment-options-con-tit">
                                <img src="<?php echo HTTPS_IMAGE_SERVER; ?>includes/templates/fiberstore/images/specials/payment_met/wire_transfer_grey.svg"
                                     width="40">
                                <span>
                                     <?php
                                     if (in_array($_SESSION['countries_iso_code'], array('us', 'pr'))) {
                                         echo PAYMENT_METHODS_WIRE_OR_ACH_TRANSFER;
                                     } else {
                                         echo PAYMENT_METHODS_WIRE_TRANSFER;
                                     }
                                     ?>
                                </span>
                            </div>
                            <p class="payment-options-con-txt">   <?php echo PAYMENT_METHODS_WIRE_TRANSFER_CONTENT_01; ?>
                                .</p>
                            <div class="payment-options-con-href">
                            ...
                            <div class="payment-options-con-tit">
                                ...
                                <span>
                                    <?php if (in_array($_SESSION['countries_iso_code'], array('us'))) {
                                        echo PAYMENT_METHODS_ECHECK_OR_CHECK;
                                    } else {
                                        echo PAYMENT_METHODS_CHECK;
                                    } ?>
                                </span>
                            </div>
                            <p class="payment-options-con-txt">
                        ...
                        <li class="payment-options-con">
                            <div class="payment-options-con-tit">
                                <img src="<?php echo HTTPS_IMAGE_SERVER; ?>includes/templates/fiberstore/images/specials/payment_met/payThods-icon06.svg"
                                     width="20">
                    ...
                    <div class="compare-features-main">
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td>  <?php echo PAYMENT_METHODS_TABLE_CONTENT_14_US; ?></td>
                            </tr>
                            <tr>
                                <td>  <?php echo PAYMENT_METHODS_NET_TERM; ?></td>
                                <td>  <?php echo PAYMENT_METHODS_TABLE_CONTENT_08; ?></td>
    ...
    <?php if (in_array($_SESSION['countries_iso_code'], array('us', 'pr'))) { ?>
        ...
        <div class="payThods-alone-popup" id="payThods-popup" style="display: none;">
            ...
            <div class="payThods-alone-680">
                <p class="payThods-alone-popupTit">
                    <span id="transfer-txt"
                          class="choosez"><?php echo PAYMENT_METHODS_PAY_WITH_WIRE_OR_ACH_TRANSFER; ?></span>
                    <span id="check-txt"><?php if ($_SESSION['countries_iso_code'] == 'us') {
                            echo PAYMENT_METHODS_PAY_WITH_ECHECK_OR_CHECK;
                        } else {
                            echo PAYMENT_METHODS_PAY_WITH_CHECK;
                        } ?></span>
                    <em class="iconfont icon payThods-alaose" onclick="$('#payThods-popup').hide()">&#xf092;</em>
                </p>
                <div class="payThods-popup-content">
                    <div class="payThods-txtBox" demData="transfer-txt">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="wire_info">
                            ...
                            <tr>
                                ...
                                <td valign="top"><b><?php echo PAYMENT_METHODS_TABLE_CONTENT_14_US; ?></b></td>
                            </tr>
                            <tr>
                    ...
                    <div class="payThods-txtBox choosez" demData="check-txt">
                        <p class="payThods-popup-txt"><?php if ($_SESSION['countries_iso_code'] == 'us') {
                                echo PAYMENT_METHODS_PAY_WITH_CONTENT_20;
                            } else {
                                echo PAYMENT_METHODS_PAY_WITH_CONTENT_12;
                            } ?></p>
                        <?php if (in_array($_SESSION['countries_iso_code'], array('us'))) { ?>
                            <p class="payThods-popup-txt03"><?php echo PAYMENT_METHODS_PAY_WITH_CONTENT_21; ?></p>
                            <div>
                                <p><?php echo PAYMENT_METHODS_PAY_WITH_CONTENT_22; ?></p>
                                <ul class="payThods-popup-txtList">
                                    <li>
                                        <i></i>
                                        <div><?php echo PAYMENT_METHODS_PAY_WITH_CONTENT_23; ?></div>
                                    </li>
                                    <li>
                                        <i></i>
                                        <div><?php echo PAYMENT_METHODS_PAY_WITH_CONTENT_24; ?></div>
                                    </li>
                                    <li>
                                        <i></i>
                                        <div><?php echo PAYMENT_METHODS_PAY_WITH_CONTENT_25; ?></div>
                                    </li>
                                </ul>
                            </div>
                        <?php } ?>
                ...
                <div class="payThods-popup-content">
                    <div class="payThods-txtBox choosez" demData="transfer-txt">
                        ...
                        <table style="margin-top:15px;" width="100%" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <th width="200"
                                    valign="top"><?php echo PAYMENT_METHODS_PAY_WITH_BANK_TRANSFER_CONTENT_04; ?></th>
                                <td valign="top"><b><?php echo PAYMENT_METHODS_TABLE_CONTENT_14_US; ?></b></td>
                            </tr>
