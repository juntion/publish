...
define('EMAIL_TEXT_HEADER', 'Conferma dell\'ordine'); 
define('EMAIL_TEXT_FROM', 'da'); 
define('EMAIL_THANKS_FOR_SHOPPING', 'Grazie per aver fatto acquisiti con noi oggi!'); 
define('EMAIL_DETAILS_FOLLOW', 'Di seguito sono riportati i dettagli dell\'ordine.'); 
define('EMAIL_TEXT_ORDER_NUMBER', 'Numero d\'ordine:'); 
define('EMAIL_TEXT_INVOICE_URL', 'Fattura dettagliata:'); 
define('EMAIL_TEXT_INVOICE_URL_CLICK', 'Fare clic qui per la fattura dettagliata'); 
define('EMAIL_TEXT_DATE_ORDERED', 'Date dell\'ordine:'); 
