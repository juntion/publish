...
define('FS_ACCOUNT_RECENT_ORDERS', 'Storico Ordini');
define('FS_ACCOUNT_ORDER_HIS', 'Storico degli ordini'); 
...
define('FS_ACCOUNT_ACCOUNT_MANAGER', 'Gestore di account');
...
define('FS_RETURN_CENTER', 'Centro resi'); 
define('FS_RETURN_TXT', 'Istruzioni per i resi');
?>