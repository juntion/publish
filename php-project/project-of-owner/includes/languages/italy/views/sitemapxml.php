...
define('TEXT_EXECUTION_TIME', 'Tempo di esecuzione totale'); 
define('TEXT_TOTAL_SITEMAP', 'Totale: file %s'); 
define('TEXT_FILE_SITEMAP_INFO', 'File <a href="%s" target="_blank">%s</a>. Scritti %s articoli (%s byte'); 
define('TEXT_WRITTEN', 'Scritti %s articoli (%s byte'); 
define('TEXT_URL_FILE', 'URL -'); 
define('TEXT_INCLUDE_FILE', 'Include'); 
define('TEXT_FILE_NOT_CHANGED', 'non è cambiato - utilizzo di file esistente/i'); 
define('TEXT_FAILED_TO_OPEN', '<span style="font-weight: bold; color: red;"> Impossibile aprire il file</span>'); 
define('TEXT_HEAD_SITEMAP_INDEX', 'Indice mappa del sito'); 
define('TEXT_HEAD_PING', 'Ping'); 
define('TEXT_ERROR_CURL_NOT_FOUND', 'Funzioni CURL non trovate - richiesto per funzioni ping/checkURL'); 
...
define('TEXT_ERROR_CURL_ERR_DOWNLOAD', 'cURL Error: Reading less than page size "%s". Download = %s'); 
