...
define('BUTTON_CREATE_ACCOUNT_ALT', 'Iscriviti'); 
define('BUTTON_LOG_OFF_ALT', 'Disconnetti'); 
define('BUTTON_ADD_TO_CART_ALT', 'Aggiungi questo al Mio carrello'); 
define('BUTTON_ADD_ADDRESS_ALT', 'Aggiungi indirizzo'); 
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT', 'Aggiungi prodotti selezionati al carrello'); 
define('BUTTON_BACK_ALT', 'Indietro'); 
define('BUTTON_BUY_NOW_ALT', 'Acquista ora'); 
define('BUTTON_CANCEL_ALT', 'Annulla'); 
define('BUTTON_CHANGE_ADDRESS_ALT', 'Cambia indirizzo'); 
define('BUTTON_CHECKOUT_ALT', 'Pagamento'); 
define('BUTTON_CONFIRM_SEND_ALT', 'Invia Certificato regalo'); 
define('BUTTON_CONFIRM_ORDER_ALT', 'Conferma ordine'); 
define('BUTTON_CONTINUE_ALT', 'Continua'); 
define('BUTTON_CONTINUE_SHOPPING_ALT', 'Continua lo shopping'); 
define('BUTTON_DELETE_ALT', 'Elimina'); 
define('BUTTON_DELETE_SMALL_ALT', 'Elimina'); 
define('BUTTON_DOWNLOAD_ALT', 'Scarica ora'); 
define('BUTTON_EDIT_SMALL_ALT', 'Modifica'); 
define('BUTTON_IN_CART_ALT', 'Aggiungi al carrello'); 
define('BUTTON_LOGIN_ALT', 'Accedi'); 
define('BUTTON_NEXT_ALT', 'Succ.'); 
define('BUTTON_PREVIOUS_ALT', 'Prec.'); 
define('BUTTON_REDEEM_ALT', 'Riscatta'); 
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Torna all\'elenco prodotti'); 
define('BUTTON_REVIEWS_ALT', 'Vai alla pagina Recensioni'); 
define('BUTTON_SEARCH_ALT', 'Cerca'); 
define('BUTTON_SEND_ALT', 'Invia ora'); 
define('BUTTON_SEND_ANOTHER_ALT', 'Invia un altro Certificato regalo'); 
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Invia un Certificato regalo'); 
define('BUTTON_SHIPPING_ESTIMATOR_ALT', 'Stimatore spedizione'); 
define('BUTTON_SOLD_OUT_ALT', 'Esaurito'); 
define('BUTTON_SOLD_OUT_SMALL_ALT', 'Esaurito'); 
define('BUTTON_SUBMIT_ALT', 'Invia le informazioni'); 
define('BUTTON_TELL_A_FRIEND_ALT', 'Dillo a un amico'); 
define('BUTTON_TELLAFRIEND_ALT', 'Dillo a un amico'); 
define('BUTTON_UNSUBSCRIBE', 'Annulla iscrizione'); 
define('BUTTON_UPDATE_ALT', 'Aggiorna'); 
define('BUTTON_VIEW_SMALL_ALT', 'Visualizza'); 
define('BUTTON_WRITE_REVIEW_ALT', 'Scrivi recensione'); 
define('BUTTON_READ_REVIEWS_ALT', 'Leggi la recensione'); 
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Vai alle informazioni dettagliate sul prodotto'); 
