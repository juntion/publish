    ...
    <div class="page_nav">
      <div class="page_nav_con">
       ...
       <div class="short_title">
			<a href="<?php echo zen_href_link('fs_single_pages','name=about_us','SSL');?>"><?php echo FS_FOOTER_ABOUT_FS;?></a>
			<a href="<?php echo zen_href_link(FILENAME_CONTACT_US);?>"><?php echo FS_FOOTER_CONTACT_US;?></a>
			<a class="title_selected" href="<?php echo zen_href_link(FILENAME_WHY_US);?>"><?php echo FS_FOOTER_WHY_US;?></a>
			<a href="<?php echo zen_href_link('fs_single_pages','name=quality_control','SSL');?>"><?php echo FS_FOOTER_QUALITY;?></a>
			<a href="<?php echo zen_href_link(FILENAME_NEWS);?>"><?php echo LATEST_NEWS;?></a>
		</div>
      </div>
    </div>
