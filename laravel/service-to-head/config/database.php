...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'uums' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL_UUMS'),
            'host' => env('DB_HOST_UUMS', '127.0.0.1'),
            'port' => env('DB_PORT_UUMS', '3306'),
            'database' => env('DB_DATABASE_UUMS', 'forge'),
            'username' => env('DB_USERNAME_UUMS', 'forge'),
            'password' => env('DB_PASSWORD_UUMS', ''),
            'unix_socket' => env('DB_SOCKET_UUMS', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'blog' => [
            ...
            'unix_socket' => env('DB_SOCKET_BLOG', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
