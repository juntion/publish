...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/css/dataTables.bootstrap4-1.10.16.min.css">
  <style>
    body {
      padding: 25px;
    }
...
<!-- FontAwesome -->
<script defer type="text/javascript" src="/js/use.fontawesome.com-releases-v5.0.6.all.js"></script>
<!-- Datatables -->
<script type="text/javascript" src="/js/jquery.dataTables-1.10.16.min.js"></script>
<script type="text/javascript" src="/js/dataTables.bootstrap4-1.10.16.min.js"></script>
