...
return [
    ...
    */
    ...
    'default_register_address' => env('WS_DEFAULT_REGISTER_ADDRESS', null),
    ...
    'push' => [
        ...
        'worker_count' => 8, #设置 BusinessWorker 进程的数量
        'event_handler' => \App\GatewayWorker\Push\PushEvent::class, # 设置使用哪个类来处理业务,业务类至少要实现onMessage静态方法，onConnect和onClose静态方法可以不用实现
        ...
        'gateway_transport' => env('WS_GATEWAY_TRANSPORT', 'tcp'), // 当为 ssl 时，开启SSL，websocket+SSL 即 wss
        'gateway_context' => [
            // 更多ssl选项请参考手册 http://php.net/manual/zh/context.ssl.php
            'ssl' => array(
                // 请使用绝对路径
                'local_cert' => env('WS_SSL_CERT_PATH', null), // 也可以是crt文件
                'local_pk' => env('WS_SSL_PK_PATH', null),
                'verify_peer' => false,
