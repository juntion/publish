...
<div class="container-fluid">
  <div class="row">
    <div class="col sidebar mb-3">
      <h1><i class="fa fa-calendar" aria-hidden="true"></i> Uums Log Viewer</h1>
      <p class="text-muted"><i>By FS</i></p>
...
<!-- FontAwesome -->
<script defer src="./js/use.fontawesome.com-releases-v5.0.6.all.js"></script>
<!-- Datatables -->
