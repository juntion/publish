...
class CreateDesignSubTasksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        // 设计各环节的子任务
        Schema::create('pm_design_sub_tasks', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('part_id')->comment('设计环节ID');
            $table->foreign('part_id')->references('id')->on('pm_design_parts')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('pm_design_sub_tasks');
    }
}
