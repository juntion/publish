...
class MobileTaskUpdateRequest extends BaseRequest
{
    public function rules(): array
    {
        return [
            ...
            'main_sub_task' => 'array',
            'main_sub_task.sub_task_id' => 'required_with:main_sub_task|exists:pm_mobile_sub_tasks,id',
            ...
            'other_sub_tasks.*.sub_task_id' => 'required_with:other_sub_tasks|exists:pm_mobile_sub_tasks,id',
