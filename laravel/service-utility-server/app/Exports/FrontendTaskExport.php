...
class FrontendTaskExport implements WithTitle, WithEvents, WithColumnFormatting
{
    ...
    public function __construct(FrontendTaskListRepository $frontendTaskList)
    {
        $this->data = $frontendTaskList->exportData();
    }
